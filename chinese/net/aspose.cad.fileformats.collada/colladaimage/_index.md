...
description: COLLADA 图像
type: docs
weight: 4210
url: /zh/net/aspose.cad.fileformats.collada/colladaimage/
---
## ColladaImage class
...
| override [Height](../../aspose.cad.fileformats.collada/colladaimage/height) { get; } | 获取图像高度。 |
| override [IsCached](../../aspose.cad.fileformats.collada/colladaimage/iscached) { get; } | 获取对象的数据当前是否缓存，不需要读取数据。 |
...
| override [Width](../../aspose.cad.fileformats.collada/colladaimage/width) { get; } | 获取图像宽度。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [CacheData](../../aspose.cad.fileformats.collada/colladaimage/cachedata)() | 缓存数据并确保不会从底层[`DataStreamContainer`](../../aspose.cad/datastreamsupporter/datastreamcontainer)执行额外的数据加载。 |
...
* 命名空间 [Aspose.CAD.FileFormats.Collada](../../aspose.cad.fileformats.collada)
* 部件 [Aspose.CAD](../../)
