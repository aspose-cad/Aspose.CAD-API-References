...
description: IGES 图像类
type: docs
weight: 28400
url: /zh/net/aspose.cad.fileformats.iges/igesimage/
---
## IgesImage class
...
| override [Height](../../aspose.cad.fileformats.iges/igesimage/height) { get; } | 获取图像高度 |
| override [IsCached](../../aspose.cad.fileformats.iges/igesimage/iscached) { get; } | 获取一个值，该值指示对象的数据当前是否被缓存，并且不需要读取数据。 |
...
| override [Width](../../aspose.cad.fileformats.iges/igesimage/width) { get; } | 获取图像宽度 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [CacheData](../../aspose.cad.fileformats.iges/igesimage/cachedata)() | 缓存数据并确保不会从底层[`DataStreamContainer`](../../aspose.cad/datastreamsupporter/datastreamcontainer)执行额外的数据加载。 |
| [CanSave](../../aspose.cad/image/cansave)(ImageOptionsBase) | 确定图像是否可以保存为传递的保存选项表示的指定文件格式。 |
| [Dispose](../../aspose.cad/disposableobject/dispose)() |  |
| [GetDrawables](../../aspose.cad.fileformats.iges/igesimage/getdrawables)() | 获取文档的几何表示 |
| override [GetStrings](../../aspose.cad.fileformats.iges/igesimage/getstrings)() | 从image中获取所有字符串值。 |
...
* 命名空间 [Aspose.CAD.FileFormats.Iges](../../aspose.cad.fileformats.iges)
* 部件 [Aspose.CAD](../../)
