...
type: docs
weight: 2870
url: /zh/net/aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/
---
...
| 姓名 | 描述 |
| --- | --- |
| [CadRevolvedSurface](cadrevolvedsurface)() | 默认构造函数。 |
...
| [AxisPoint](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/axispoint) { get; set; } |  |
| [AxisVector](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/axisvector) { get; set; } |  |
| [BinaryDataSize](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/binarydatasize) { get; set; } |  |
...
| [CloseToAxisFlag](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/closetoaxisflag) { get; set; } |  |
...
| [DraftAngle](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/draftangle) { get; set; } |  |
| [EmbeddedObjectsContainer](../../aspose.cad.fileformats.cad.cadobjects/cadbase/embeddedobjectscontainer) { get; set; } |  |
| [EndDraftDistance](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/enddraftdistance) { get; set; } |  |
...
| [IdOfRevolveEntity](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/idofrevolveentity) { get; set; } |  |
...
| [RevolveAngle](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/revolveangle) { get; set; } |  |
| [RevolvedSurfaceBinaryData](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/revolvedsurfacebinarydata) { get; set; } |  |
...
| [SolidFlag](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/solidflag) { get; set; } |  |
| [SpaceMode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/spacemode) { get; set; } |  |
| [StartAngle](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/startangle) { get; set; } |  |
| [StartDraftDistance](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/startdraftdistance) { get; set; } |  |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag) { get; set; } |  |
| [TransformMatrix](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/transformmatrix) { get; set; } |  |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency) { get; set; } |  |
| [TwistAngle](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/twistangle) { get; set; } |  |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadrevolvedsurface/typename) { get; } |  |
