...
type: docs
weight: 2540
url: /zh/net/aspose.cad.fileformats.cad.cadobjects/cadleader/
---
## CadLeader class
...
| 姓名 | 描述 |
| --- | --- |
| [CadLeader](cadleader)() | 默认构造函数。 |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [AnnotationPlacementPointOffset](../../aspose.cad.fileformats.cad.cadobjects/cadleader/annotationplacementpointoffset) { get; set; } |  |
| [AnnotType](../../aspose.cad.fileformats.cad.cadobjects/cadleader/annottype) { get; set; } |  |
| [ApplicationCodesContainer](../../aspose.cad.fileformats.cad.cadobjects/cadbase/applicationcodescontainer) { get; set; } |  |
| [ArrowHeadFlag](../../aspose.cad.fileformats.cad.cadobjects/cadleader/arrowheadflag) { get; set; } |  |
| [AssociatedAnnotation](../../aspose.cad.fileformats.cad.cadobjects/cadleader/associatedannotation) { get; set; } |  |
...
| [Coordinates](../../aspose.cad.fileformats.cad.cadobjects/cadleader/coordinates) { get; set; } |  |
| [CreationFlag](../../aspose.cad.fileformats.cad.cadobjects/cadleader/creationflag) { get; set; } |  |
...
| [HookLineCreationFlag](../../aspose.cad.fileformats.cad.cadobjects/cadleader/hooklinecreationflag) { get; set; } |  |
| [HookLineFlag](../../aspose.cad.fileformats.cad.cadobjects/cadleader/hooklineflag) { get; set; } |  |
| [HorizontalDirection](../../aspose.cad.fileformats.cad.cadobjects/cadleader/horizontaldirection) { get; set; } |  |
...
| [LastLeaderVertex](../../aspose.cad.fileformats.cad.cadobjects/cadleader/lastleadervertex) { get; set; } |  |
...
| [LeaderColor](../../aspose.cad.fileformats.cad.cadobjects/cadleader/leadercolor) { get; set; } |  |
...
| [NormalVector](../../aspose.cad.fileformats.cad.cadobjects/cadleader/normalvector) { get; set; } |  |
...
| [PathType](../../aspose.cad.fileformats.cad.cadobjects/cadleader/pathtype) { get; set; } |  |
...
| [StyleType](../../aspose.cad.fileformats.cad.cadobjects/cadleader/styletype) { get; set; } |  |
| [TextHeight](../../aspose.cad.fileformats.cad.cadobjects/cadleader/textheight) { get; set; } |  |
| [TextWidth](../../aspose.cad.fileformats.cad.cadobjects/cadleader/textwidth) { get; set; } |  |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency) { get; set; } |  |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadleader/typename) { get; } |  |
| [VerticesCount](../../aspose.cad.fileformats.cad.cadobjects/cadleader/verticescount) { get; set; } |  |
