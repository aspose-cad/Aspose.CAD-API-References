...
type: docs
weight: 2580
url: /zh/net/aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/
---
...
| 姓名 | 描述 |
| --- | --- |
| [CadLoftedSurface](cadloftedsurface)() | 默认构造函数。 |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [AlignDirectionFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/aligndirectionflag) { get; set; } |  |
| [ApplicationCodesContainer](../../aspose.cad.fileformats.cad.cadobjects/cadbase/applicationcodescontainer) { get; set; } |  |
| [ArcLengthParamFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/arclengthparamflag) { get; set; } |  |
...
| [ClosedSurfaceFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/closedsurfaceflag) { get; set; } |  |
...
| [EndDraftAngle](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/enddraftangle) { get; set; } |  |
| [EndDraftMagnitude](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/enddraftmagnitude) { get; set; } |  |
...
| [PlaneNormalType](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/planenormaltype) { get; set; } |  |
...
| [RuledSurfaceFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/ruledsurfaceflag) { get; set; } |  |
| [ShadowMode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/shadowmode) { get; set; } |  |
| [SimpleSurfaceFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/simplesurfaceflag) { get; set; } |  |
| [SoftOwner](../../aspose.cad.fileformats.cad.cadobjects/cadbaseowned/softowner) { get; set; } |  |
| [SolidFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/solidflag) { get; set; } |  |
| [SpaceMode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/spacemode) { get; set; } |  |
| [StartDraftAngle](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/startdraftangle) { get; set; } |  |
| [StartDraftMagnitude](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/startdraftmagnitude) { get; set; } |  |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag) { get; set; } |  |
| [TransformMatrix](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/transformmatrix) { get; set; } |  |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency) { get; set; } |  |
| [TwistFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/twistflag) { get; set; } |  |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/typename) { get; } |  |
| [VirtualGuideFlag](../../aspose.cad.fileformats.cad.cadobjects/cadloftedsurface/virtualguideflag) { get; set; } |  |
