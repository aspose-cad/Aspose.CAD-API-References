...
type: docs
weight: 600
url: /zh/net/aspose.cad.fileformats.ifc.ifc2x3.entities/
---
...
| [IfcColourRgb](./ifccolourrgb) | 部分 IIfc 实体类 |
| [IfcColourSpecification](./ifccolourspecification) | 部分 IIfc 实体类 |
...
| [IfcPlanarExtent](./ifcplanarextent) | 部分 IIfc 实体类 |
...
| [IfcPreDefinedItem](./ifcpredefineditem) | 部分 IIfc 实体类 |
...
| [IfcPreDefinedTextFont](./ifcpredefinedtextfont) | 部分 IIfc 实体类 |
...
| [IfcPresentationStyle](./ifcpresentationstyle) | 部分 IIfc 实体类 |
| [IfcPresentationStyleAssignment](./ifcpresentationstyleassignment) | 部分 IIfc 实体类 |
...
| [IfcStyledItem](./ifcstyleditem) | 部分 IIfc 实体类 |
...
| [IfcTextLiteral](./ifctextliteral) | 部分 IIfc 实体类 |
| [IfcTextLiteralWithExtent](./ifctextliteralwithextent) | 部分 IIfc 实体类 |
| [IfcTextStyle](./ifctextstyle) | 部分 IIfc 实体类 |
| [IfcTextStyleFontModel](./ifctextstylefontmodel) | 部分 IIfc 实体类 |
| [IfcTextStyleForDefinedFont](./ifctextstylefordefinedfont) | 部分 IIfc 实体类 |
