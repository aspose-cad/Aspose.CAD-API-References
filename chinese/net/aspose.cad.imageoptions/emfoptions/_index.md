...
description: EMF 文件格式创建选项
type: docs
weight: 29650
url: /zh/net/aspose.cad.imageoptions/emfoptions/
---
## EmfOptions class
...
| 姓名 | 描述 |
| --- | --- |
| [EmfOptions](emfoptions#constructor)() | 初始化[`EmfOptions`](../emfoptions)类的新实例。 |
| [EmfOptions](emfoptions#constructor_1)(EmfOptions) | 初始化[`EmfOptions`](../emfoptions)类的新实例。 |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [Compress](../../aspose.cad.imageoptions/emfoptions/compress) { get; set; } | 获取或设置一个值，该值指示此实例是否被压缩。 |
