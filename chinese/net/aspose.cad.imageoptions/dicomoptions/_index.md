...
type: docs
weight: 29620
url: /zh/net/aspose.cad.imageoptions/dicomoptions/
---
## DicomOptions class
...
| 姓名 | 描述 |
| --- | --- |
| [DicomOptions](dicomoptions)() | 初始化[`DicomOptions`](../dicomoptions)类的新实例。 |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [ColorType](../../aspose.cad.imageoptions/dicomoptions/colortype) { get; set; } | 获取或设置颜色的类型。 |
| [Compression](../../aspose.cad.imageoptions/dicomoptions/compression) { get; set; } | 获取或设置压缩。 |
