...
type: docs
weight: 3750
url: /zh/net/aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/
---
...
| 姓名 | 描述 |
| --- | --- |
| [CadWipeoutRasterImage](cadwipeoutrasterimage)() | 默认构造函数。 |
...
| override [ClassVersion](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/classversion) { get; set; } |  |
| [ClipBoundaries](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/clipboundaries) { get; set; } |  |
| override [ClipBoundariesCount](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/clipboundariescount) { get; set; } |  |
| override [ClippingBoundaryType](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/clippingboundarytype) { get; set; } |  |
| override [ClippingState](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/clippingstate) { get; set; } |  |
...
| override [Fade](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/fade) { get; set; } |  |
...
| override [ImageDefReactorReference](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/imagedefreactorreference) { get; set; } |  |
| override [ImageDefReference](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/imagedefreference) { get; set; } |  |
| override [ImageDisplayProp](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/imagedisplayprop) { get; set; } |  |
| override [ImageSizeInPixels](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/imagesizeinpixels) { get; set; } |  |
| override [InsertionPoint](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/insertionpoint) { get; set; } |  |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/typename) { get; } |  |
| override [VectorU](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/vectoru) { get; set; } |  |
| override [VectorV](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/vectorv) { get; set; } |  |
| virtual [Visible](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/visible) { get; set; } |  |
| override [WipeoutBrightness](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/wipeoutbrightness) { get; set; } |  |
| override [WipeoutContrast](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutrasterimage/wipeoutcontrast) { get; set; } |  |
...
* 命名空间 [Aspose.CAD.FileFormats.Cad.CadObjects.Wipeout](../../aspose.cad.fileformats.cad.cadobjects.wipeout)
* 部件 [Aspose.CAD](../../)
