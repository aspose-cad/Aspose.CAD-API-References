...
type: docs
weight: 3690
url: /zh/net/aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/
---
## CadFaceRecord class
...
| 姓名 | 描述 |
| --- | --- |
| [CadFaceRecord](cadfacerecord)() | 默认构造函数。 |
...
| override [Bugle](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/bugle) { get; set; } |  |
...
| override [CurveFitTangentDirection](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/curvefittangentdirection) { get; set; } |  |
| [EmbeddedObjectsContainer](../../aspose.cad.fileformats.cad.cadobjects/cadbase/embeddedobjectscontainer) { get; set; } |  |
| override [EndingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/endingwidth) { get; set; } |  |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode) { get; set; } |  |
| override [Flags](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/flags) { get; set; } |  |
...
| override [LocationPoint](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/locationpoint) { get; set; } |  |
...
| override [MeshVertexIndex1](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/meshvertexindex1) { get; set; } |  |
| override [MeshVertexIndex2](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/meshvertexindex2) { get; set; } |  |
| override [MeshVertexIndex3](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/meshvertexindex3) { get; set; } |  |
| override [MeshVertexIndex4](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/meshvertexindex4) { get; set; } |  |
...
| override [StartingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/startingwidth) { get; set; } |  |
...
| override [VertexId](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/vertexid) { get; set; } |  |
