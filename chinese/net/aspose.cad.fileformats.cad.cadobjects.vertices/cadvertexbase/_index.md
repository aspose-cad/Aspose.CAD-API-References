...
type: docs
weight: 3710
url: /zh/net/aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/
---
## CadVertexBase class
...
| 姓名 | 描述 |
| --- | --- |
| [CadVertexBase](cadvertexbase)() | 默认构造函数。 |
...
| virtual [Bugle](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/bugle) { get; set; } |  |
...
| virtual [CurveFitTangentDirection](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/curvefittangentdirection) { get; set; } |  |
| [EmbeddedObjectsContainer](../../aspose.cad.fileformats.cad.cadobjects/cadbase/embeddedobjectscontainer) { get; set; } |  |
| virtual [EndingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/endingwidth) { get; set; } |  |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode) { get; set; } |  |
| virtual [Flags](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/flags) { get; set; } |  |
...
| virtual [LocationPoint](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/locationpoint) { get; set; } |  |
...
| virtual [MeshVertexIndex1](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/meshvertexindex1) { get; set; } |  |
| virtual [MeshVertexIndex2](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/meshvertexindex2) { get; set; } |  |
| virtual [MeshVertexIndex3](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/meshvertexindex3) { get; set; } |  |
| virtual [MeshVertexIndex4](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/meshvertexindex4) { get; set; } |  |
...
| virtual [StartingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/startingwidth) { get; set; } |  |
...
| virtual [VertexId](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/vertexid) { get; set; } |  |
