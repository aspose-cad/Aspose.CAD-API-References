...
type: docs
weight: 28600
url: /zh/net/aspose.cad.fileformats.plt/pltimage/
---
## PltImage class
...
| override [Height](../../aspose.cad.fileformats.plt/pltimage/height) { get; } | 获取图像高度。 |
| override [IsCached](../../aspose.cad.fileformats.plt/pltimage/iscached) { get; } | 获取对象的数据当前是否缓存，不需要读取数据。 |
| [Pages](../../aspose.cad.fileformats.plt/pltimage/pages) { get; } | 获取页面 |
...
| override [Width](../../aspose.cad.fileformats.plt/pltimage/width) { get; } | 获取图像宽度。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [CacheData](../../aspose.cad.fileformats.plt/pltimage/cachedata)() | 缓存数据并确保不会从底层[`DataStreamContainer`](../../aspose.cad/datastreamsupporter/datastreamcontainer)执行额外的数据加载。 |
| [CanSave](../../aspose.cad/image/cansave)(ImageOptionsBase) | 确定图像是否可以保存为传递的保存选项表示的指定文件格式。 |
| [Dispose](../../aspose.cad/disposableobject/dispose)() |  |
| override [GetStrings](../../aspose.cad.fileformats.plt/pltimage/getstrings)() | 从image中获取所有字符串值。 |
...
* 命名空间 [Aspose.CAD.FileFormats.Plt](../../aspose.cad.fileformats.plt)
* 部件 [Aspose.CAD](../../)
