...
type: docs
weight: 3500
url: /zh/net/aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/
---
...
| 姓名 | 描述 |
| --- | --- |
| [CadPolyFaceMesh](cadpolyfacemesh)() | 默认构造函数。 |
...
| override [Elevation](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/elevation) { get; set; } |  |
| [EmbeddedObjectsContainer](../../aspose.cad.fileformats.cad.cadobjects/cadbase/embeddedobjectscontainer) { get; set; } |  |
| override [EndWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/endwidth) { get; set; } |  |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode) { get; set; } |  |
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/extrusiondirection) { get; set; } |  |
...
| override [MeshMVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/meshmvertexcount) { get; set; } |  |
| override [MeshNVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/meshnvertexcount) { get; set; } |  |
...
| override [StartWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/startwidth) { get; set; } |  |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag) { get; set; } |  |
| override [SurfaceMDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/surfacemdensity) { get; set; } |  |
| override [SurfaceNDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/surfacendensity) { get; set; } |  |
| override [SurfaceType](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/surfacetype) { get; set; } |  |
| override [Thickness](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/thickness) { get; set; } |  |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency) { get; set; } |  |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyfacemesh/typename) { get; } |  |
