...
type: docs
weight: 28930
url: /zh/net/aspose.cad.fileformats.svg/svgimage/
---
## SvgImage class
...
| override [Height](../../aspose.cad.fileformats.svg/svgimage/height) { get; } | 获取图像高度。 |
| override [IsCached](../../aspose.cad.fileformats.svg/svgimage/iscached) { get; } | 获取图像是否被缓存 |
...
| override [Width](../../aspose.cad.fileformats.svg/svgimage/width) { get; } | 获取图像宽度。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [CacheData](../../aspose.cad.fileformats.svg/svgimage/cachedata)() | 缓存图像 |
| [CanSave](../../aspose.cad/image/cansave)(ImageOptionsBase) | 确定图像是否可以保存为传递的保存选项表示的指定文件格式。 |
| [Dispose](../../aspose.cad/disposableobject/dispose)() |  |
| override [GetStrings](../../aspose.cad.fileformats.svg/svgimage/getstrings)() | 从image中获取所有字符串值。 |
...
* 命名空间 [Aspose.CAD.FileFormats.Svg](../../aspose.cad.fileformats.svg)
* 部件 [Aspose.CAD](../../)
