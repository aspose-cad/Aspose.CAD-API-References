...
type: docs
weight: 28260
url: /zh/net/aspose.cad.fileformats.ifc/ifcimage/
---
## IfcImage class
...
| [Depth](../../aspose.cad.fileformats.ifc/ifcimage/depth) { get; } | 获取深度。 |
| [Disposed](../../aspose.cad/disposableobject/disposed) { get; } |  |
| [Entities](../../aspose.cad.fileformats.ifc/ifcimage/entities) { get; } | 获取实体。 |
| override [Height](../../aspose.cad.fileformats.ifc/ifcimage/height) { get; } | 获取图像高度。 |
| override [IsCached](../../aspose.cad.fileformats.ifc/ifcimage/iscached) { get; } | 获取一个值，该值指示对象的数据当前是否被缓存，并且不需要读取数据。 |
| [Layers](../../aspose.cad.fileformats.ifc/ifcimage/layers) { get; } | 获取图像中的图层列表 |
...
| override [Width](../../aspose.cad.fileformats.ifc/ifcimage/width) { get; } | 获取图像宽度。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [CacheData](../../aspose.cad.fileformats.ifc/ifcimage/cachedata)() | 缓存数据并确保不会从底层[`DataStreamContainer`](../../aspose.cad/datastreamsupporter/datastreamcontainer)执行额外的数据加载。 |
| [CanSave](../../aspose.cad/image/cansave)(ImageOptionsBase) | 确定图像是否可以保存为传递的保存选项表示的指定文件格式。 |
| [Dispose](../../aspose.cad/disposableobject/dispose)() |  |
| override [GetStrings](../../aspose.cad.fileformats.ifc/ifcimage/getstrings)() | 从image中获取所有字符串值。 |
