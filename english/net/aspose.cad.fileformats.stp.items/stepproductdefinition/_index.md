...
```csharp
public class StepProductDefinition : StepRepresentationItem
```
...
| Name | Description |
| --- | --- |
| [DefinitionContext](../../aspose.cad.fileformats.stp.items/stepproductdefinition/definitioncontext/) { get; set; } |  |
