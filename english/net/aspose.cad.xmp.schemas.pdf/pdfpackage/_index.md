...
| Name | Description |
| --- | --- |
| override [AddValue](../../aspose.cad.xmp.schemas.pdf/pdfpackage/addvalue/)(string, string) | Adds string property. |
...
| [SetKeywords](../../aspose.cad.xmp.schemas.pdf/pdfpackage/setkeywords/)(string) | Sets the keywords. |
| [SetPdfVersion](../../aspose.cad.xmp.schemas.pdf/pdfpackage/setpdfversion/)(string) | Sets the PDF version. |
| [SetProducer](../../aspose.cad.xmp.schemas.pdf/pdfpackage/setproducer/)(string) | Sets the name of the tool that created Pdf. |
| [SetTrapped](../../aspose.cad.xmp.schemas.pdf/pdfpackage/settrapped/)(bool) | Sets the trapped. |
