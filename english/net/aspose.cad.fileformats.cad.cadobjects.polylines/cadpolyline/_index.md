---
title: Class CadPolyline
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.Polylines.CadPolyline class. Class describing Cad POLYLINE
type: docs
weight: 3610
...
| override [Elevation](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/elevation/) { get; set; } | Gets or sets the elevation. |
...
| override [EndWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/endwidth/) { get; set; } | Gets or sets the end width. |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode/) { get; set; } | The Entmode |
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
...
| override [MeshMVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/meshmvertexcount/) { get; set; } | Gets or sets the mesh M vertex count. |
| override [MeshNVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/meshnvertexcount/) { get; set; } | Gets or sets the mesh N vertex count. |
...
| override [StartWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/startwidth/) { get; set; } | Gets or sets the start width. |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag/) { get; set; } | The StorageFlag |
| override [SurfaceMDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/surfacemdensity/) { get; set; } | Gets or sets the surface M density. |
| override [SurfaceNDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/surfacendensity/) { get; set; } | Gets or sets the surface N density. |
| override [SurfaceType](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/surfacetype/) { get; set; } | Gets or sets the type of the surface. |
| override [Thickness](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/thickness/) { get; set; } | Gets or sets the Thickness |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/typename/) { get; } | Gets the name of the type. |
