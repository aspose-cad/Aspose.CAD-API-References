---
title: Class CadSolidBackground
...
```csharp
public class CadSolidBackground : CadBaseObject
```
...
| Name | Description |
| --- | --- |
| [CadSolidBackground](cadsolidbackground/)() | The default constructor. |
...
| [ColorValue](../../aspose.cad.fileformats.cad.cadobjects.background/cadsolidbackground/colorvalue/) { get; set; } | Gets or sets the solid color (RGB) value for the background. |
