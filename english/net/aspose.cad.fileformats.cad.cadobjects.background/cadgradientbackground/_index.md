---
title: Class CadGradientBackground
...
| Name | Description |
| --- | --- |
| [CadGradientBackground](cadgradientbackground/)() | The default constructor. |
...
| [ColorBottomValue](../../aspose.cad.fileformats.cad.cadobjects.background/cadgradientbackground/colorbottomvalue/) { get; set; } | Gets or sets the color (RGB) value for the bottom of the gradient. |
| [ColorMiddleValue](../../aspose.cad.fileformats.cad.cadobjects.background/cadgradientbackground/colormiddlevalue/) { get; set; } | Gets or sets the color (RGB) value for the middle of the gradient. |
| [ColorTopValue](../../aspose.cad.fileformats.cad.cadobjects.background/cadgradientbackground/colortopvalue/) { get; set; } | Gets or sets the color (RGB) value for the top of the gradient. |
...
| [Height](../../aspose.cad.fileformats.cad.cadobjects.background/cadgradientbackground/height/) { get; } | Gets a value representing a percentage of the second color in a three-color gradient. |
| [Horizon](../../aspose.cad.fileformats.cad.cadobjects.background/cadgradientbackground/horizon/) { get; set; } | Gets or sets the horizon value indicating the percentage of unrotated height. |
