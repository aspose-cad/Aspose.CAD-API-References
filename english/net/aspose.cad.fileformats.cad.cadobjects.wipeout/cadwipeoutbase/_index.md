...
```csharp
public class CadWipeoutBase : CadEntityBase
```
...
| virtual [ClassVersion](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/classversion/) { get; set; } | Gets or sets the class version. |
...
| virtual [ClipBoundariesCount](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/clipboundariescount/) { get; set; } | Gets or sets the clip boundaries count. |
| virtual [ClippingBoundaryType](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/clippingboundarytype/) { get; set; } | Gets or sets the type of the clipping boundary. |
| virtual [ClippingState](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/clippingstate/) { get; set; } | Gets or sets the clipping state. |
...
| virtual [Fade](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/fade/) { get; set; } | Gets or sets the fade. |
...
| virtual [ImageDefReactorReference](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/imagedefreactorreference/) { get; set; } | Gets or sets the image def reactor reference. |
| virtual [ImageDefReference](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/imagedefreference/) { get; set; } | Gets or sets the image def reference. |
| virtual [ImageDisplayProp](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/imagedisplayprop/) { get; set; } | Gets or sets the image display prop. |
| virtual [ImageSizeInPixels](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/imagesizeinpixels/) { get; set; } | Gets or sets the image size in pixels. |
| virtual [InsertionPoint](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/insertionpoint/) { get; set; } | Gets or sets the insertion point. |
...
| virtual [VectorU](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/vectoru/) { get; set; } | Gets or sets the vector u. |
| virtual [VectorV](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/vectorv/) { get; set; } | Gets or sets the vector v. |
...
| virtual [WipeoutBrightness](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/wipeoutbrightness/) { get; set; } | Gets or sets the wipeout brightness. |
| virtual [WipeoutContrast](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/wipeoutcontrast/) { get; set; } | Gets or sets the contrast. |
