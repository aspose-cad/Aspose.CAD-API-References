---
title: Class CadWipeout
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.Wipeout.CadWipeout class. The Cad wipeout
type: docs
weight: 4120
...
| Name | Description |
| --- | --- |
| [CadWipeout](cadwipeout/)() | Initializes a new instance of the `CadWipeout` class. |
...
| override [ClassVersion](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/classversion/) { get; set; } | Gets or sets the class version. |
...
| override [ClipBoundariesCount](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/clipboundariescount/) { get; set; } | Gets or sets the clip boundaries count. |
| override [ClippingBoundaryType](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/clippingboundarytype/) { get; set; } | Gets or sets the type of the clipping boundary. |
| [ClippingMode](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/clippingmode/) { get; set; } | The Clipping Mode |
| override [ClippingState](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/clippingstate/) { get; set; } | Gets or sets the clipping state. |
...
| override [Fade](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/fade/) { get; set; } | Gets or sets the fade. |
...
| override [ImageDefReactorReference](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/imagedefreactorreference/) { get; set; } | Gets or sets the image def reactor reference. |
| override [ImageDefReference](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/imagedefreference/) { get; set; } | Gets or sets the image def reference. |
| override [ImageDisplayProp](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/imagedisplayprop/) { get; set; } | Gets or sets the image display prop. |
| override [ImageSizeInPixels](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/imagesizeinpixels/) { get; set; } | Gets or sets the image size in pixels. |
| override [InsertionPoint](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/insertionpoint/) { get; set; } | Gets or sets the insertion point. |
...
| override [VectorU](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/vectoru/) { get; set; } | Gets or sets the vector u. |
| override [VectorV](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/vectorv/) { get; set; } | Gets or sets the vector v. |
...
| override [WipeoutBrightness](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/wipeoutbrightness/) { get; set; } | Gets or sets the wipeout brightness. |
| override [WipeoutContrast](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/wipeoutcontrast/) { get; set; } | Gets or sets the contrast. |
