---
title: Class CameraBuilder.Perspective
...
| Name | Description |
| --- | --- |
| [Perspective](../../aspose.cad.fileformats.glb.scenes/camerabuilder.perspective/.ctor)(float?, float, float, float) |  |

## Properties

| Name | Description |
| --- | --- |
| [AspectRatio](../../aspose.cad.fileformats.glb.scenes/camerabuilder.perspective/aspectratio) { get; set; } | Gets or sets the aspect ratio between horizontal window size and vertical window size. |
...
| [VerticalFOV](../../aspose.cad.fileformats.glb.scenes/camerabuilder.perspective/verticalfov) { get; set; } | Gets or sets the vertical field of view, in radians |
...
| Name | Description |
| --- | --- |
| override [Clone](../../aspose.cad.fileformats.glb.scenes/camerabuilder.perspective/clone)() |  |
