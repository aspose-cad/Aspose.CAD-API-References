---
title: Class CadStyleTableObject
...
```csharp
public class CadStyleTableObject : CadOwnedObjectBase
```
...
| [BigFontName](../../aspose.cad.fileformats.cad.cadtables/cadstyletableobject/bigfontname/) { get; set; } | Gets or sets the big font nameCadStyleTableObject |
...
| [FixedHeight](../../aspose.cad.fileformats.cad.cadtables/cadstyletableobject/fixedheight/) { get; set; } | Gets or sets the fixed height. |
...
| [LastHeight](../../aspose.cad.fileformats.cad.cadtables/cadstyletableobject/lastheight/) { get; set; } | Gets or sets the last height. |
...
| [ObliqueAngle](../../aspose.cad.fileformats.cad.cadtables/cadstyletableobject/obliqueangle/) { get; set; } | Gets or sets the oblique angle. |
...
| [WidthFactor](../../aspose.cad.fileformats.cad.cadtables/cadstyletableobject/widthfactor/) { get; set; } | Gets or sets the width factor. |
