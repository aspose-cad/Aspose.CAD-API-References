---
title: Class CadAppIdTableObject
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadTables.CadAppIdTableObject class. The Cad app id table
type: docs
weight: 4210
...
```csharp
public class CadAppIdTableObject : CadOwnedObjectBase
```
...
| [ApplicationFlag](../../aspose.cad.fileformats.cad.cadtables/cadappidtableobject/applicationflag/) { get; set; } | Gets or sets the application flag. |
| [AppName](../../aspose.cad.fileformats.cad.cadtables/cadappidtableobject/appname/) { get; set; } | Gets or sets the app name. |
