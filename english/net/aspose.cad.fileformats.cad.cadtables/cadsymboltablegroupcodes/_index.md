---
title: Class CadSymbolTableGroupCodes
...
```csharp
public class CadSymbolTableGroupCodes : CadOwnedObjectBase, ICloneable
```
...
| Name | Description |
| --- | --- |
| [CadSymbolTableGroupCodes](cadsymboltablegroupcodes/)() | Initializes a new instance of the `CadSymbolTableGroupCodes` class. |
...
| [IsInit](../../aspose.cad.fileformats.cad.cadtables/cadsymboltablegroupcodes/isinit/) { get; } | Gets or sets a value indicating whether this instance is initialize. |
...
| [MaxTableEntriesCount](../../aspose.cad.fileformats.cad.cadtables/cadsymboltablegroupcodes/maxtableentriescount/) { get; set; } | Gets or sets the maximum table entries count. |
...
| Name | Description |
| --- | --- |
| [Clone](../../aspose.cad.fileformats.cad.cadtables/cadsymboltablegroupcodes/clone/)() | Creates a new object that is a copy of the current instance. |
...
| [Init](../../aspose.cad.fileformats.cad.cadtables/cadsymboltablegroupcodes/init/)() | Initializes this instance. |
