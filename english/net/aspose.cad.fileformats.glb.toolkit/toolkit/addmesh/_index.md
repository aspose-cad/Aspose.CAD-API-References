---
title: Toolkit.AddMesh
second_title: Aspose.CAD for .NET API Reference
description: Toolkit method. 
type: docs
weight: 10
url: /net/aspose.cad.fileformats.glb.toolkit/toolkit/addmesh/
---
## Toolkit.AddMesh&lt;TMaterial,TvG,TvM,TvS&gt; method

```csharp
public static void AddMesh<TMaterial, TvG, TvM, TvS>(
    this MeshBuilder<TMaterial, TvG, TvM, TvS> meshBuilder, Mesh srcMesh, 
    Converter<Material, TMaterial> materialFunc)
