---
title: Class CadBlockAligmentParameter
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.Blocks.CadBlockAligmentParameter class. Class describing block aligment parameter
type: docs
weight: 1740
...
| Name | Description |
| --- | --- |
| [CadBlockAligmentParameter](cadblockaligmentparameter/)() | Initializes a new instance of the `CadBlockAligmentParameter` class. |
...
| [BlockAligmentParameterList](../../aspose.cad.fileformats.cad.cadobjects.blocks/cadblockaligmentparameter/blockaligmentparameterlist/) { get; set; } | Gets or sets the block visibility parameter list. |
