---
title: Class CadSectionSettings
...
| Name | Description |
| --- | --- |
| [CadSectionSettings](cadsectionsettings/)() | Initializes a new instance of the `CadSectionSettings` class. |
...
| [GenerationSettingsNumber](../../aspose.cad.fileformats.cad.cadobjects.section/cadsectionsettings/generationsettingsnumber/) { get; set; } | Gets or sets the generation settings number. |
...
| [SectionType](../../aspose.cad.fileformats.cad.cadobjects.section/cadsectionsettings/sectiontype/) { get; set; } | Gets or sets the type of the section. |
| [SectionTypeSettings](../../aspose.cad.fileformats.cad.cadobjects.section/cadsectionsettings/sectiontypesettings/) { get; set; } | Gets or sets the section type settings. |
