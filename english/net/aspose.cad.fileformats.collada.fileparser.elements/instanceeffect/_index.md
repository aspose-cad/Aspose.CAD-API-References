...
| [SetParameter](setparameter) { get; set; } | Gets or sets the set parameter. Assigns a new value to a previously defined parameter. |
...
| [TechniqueHint](techniquehint) { get; set; } | Gets or sets the technique hint. Add a hint for a platform of which technique to use in this effect. |
