...
| Name | Description |
| --- | --- |
| [Count](count) { get; set; } | Gets or sets the count. The count attribute indicates the number of triangle fan primitives. Required attribute. |
...
| [Primitives](primitives) { get; set; } | Gets or sets the primitives. The TRIFANS element may have any number of primitives elements. |
