---
title: Class CadAcDbMLeaderObjectContextDataClass
...
| Name | Description |
| --- | --- |
| [CadAcDbMLeaderObjectContextDataClass](cadacdbmleaderobjectcontextdataclass/)() | Initializes a new instance of the `CadAcDbMLeaderObjectContextDataClass` class. |

## Properties

| Name | Description |
| --- | --- |
| [AnnotateScaleParameterList](../../aspose.cad.fileformats.cad.cadobjects.objectcontextdataclasses/cadacdbmleaderobjectcontextdataclass/annotatescaleparameterlist/) { get; set; } | Gets or sets the annotate scale parameter list. |
