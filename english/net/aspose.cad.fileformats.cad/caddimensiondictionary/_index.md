---
title: Class CadDimensionDictionary
...
| Name | Description |
| --- | --- |
| [CadSymbolTableGroupCodes](../../aspose.cad.fileformats.cad/caddimensiondictionary/cadsymboltablegroupcodes/) { get; set; } | Gets or sets the cad symbol table group codes. |
...
| [Item](../../aspose.cad.fileformats.cad/caddimensiondictionary/item/) { get; set; } | Gets or sets the [`CadDimensionStyleTable`](../../aspose.cad.fileformats.cad.cadtables/caddimensionstyletable/) with the specified key. (2 indexers) |
| [Keys](../../aspose.cad/nongenericdictionary/keys/) { get; } | Gets an ICollection object containing the keys of the IDictionary object. |
| [KeysTyped](../../aspose.cad.fileformats.cad/caddimensiondictionary/keystyped/) { get; } | Gets the strongly typed collection of keys. |
...
| [ValuesTyped](../../aspose.cad.fileformats.cad/caddimensiondictionary/valuestyped/) { get; } | Gets the strongly typed values collection. |
...
| [Add](../../aspose.cad.fileformats.cad/caddimensiondictionary/add/#add_1)(string, CadDimensionStyleTable) | Adds a [`CadDimensionStyleTable`](../../aspose.cad.fileformats.cad.cadtables/caddimensionstyletable/) to the dictionary. |
| [Clear](../../aspose.cad/nongenericdictionary/clear/)() | Removes all elements from the IDictionary object. |
| [Clone](../../aspose.cad.fileformats.cad/caddimensiondictionary/clone/)() | Clones the dictionary. |
...
| [ContainsKey](../../aspose.cad.fileformats.cad/caddimensiondictionary/containskey/)(string) | Determines whether [`CadDimensionStyleTable`](../../aspose.cad.fileformats.cad.cadtables/caddimensionstyletable/) contained within this dictionary. |
...
| [Remove](../../aspose.cad.fileformats.cad/caddimensiondictionary/remove/#remove)(string) | Removes the [`CadDimensionStyleTable`](../../aspose.cad.fileformats.cad.cadtables/caddimensionstyletable/) with the specified key. |
| [TryGetValue](../../aspose.cad.fileformats.cad/caddimensiondictionary/trygetvalue/)(string, out CadDimensionStyleTable) | Gets the value associated with the specified key. |
