...
```csharp
public class DwgImage : CadImage
```
...
| Name | Description |
| --- | --- |
| [DwgImage](dwgimage/)(CadAcadVersion) | Initializes a new instance of the `DwgImage` class. |
...
| Name | Description |
| --- | --- |
| [AddEntity](../../aspose.cad.fileformats.cad/dwgimage/addentity/)(CadEntityBase) | Add entity to drawing |
