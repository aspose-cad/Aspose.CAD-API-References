---
title: Class CadBinaryAttribute
...
public class CadBinaryAttribute : CadSingleValueProperty
```
...
| Name | Description |
| --- | --- |
| [CadBinaryAttribute](cadbinaryattribute/)(CadEntityAttribute, CadParameterType, string) | Initializes a new instance of the `CadBinaryAttribute` class. |
