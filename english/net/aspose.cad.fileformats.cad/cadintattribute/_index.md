...
public class CadIntAttribute : CadSingleValueProperty
```
...
| Name | Description |
| --- | --- |
| [CadIntAttribute](cadintattribute/)(CadEntityAttribute, CadParameterType, string) | Initializes a new instance of the `CadIntAttribute` class. |
