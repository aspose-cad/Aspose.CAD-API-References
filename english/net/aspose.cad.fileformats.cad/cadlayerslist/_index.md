...
| Name | Description |
| --- | --- |
| [ApplicationCodesContainer](../../aspose.cad.fileformats.cad/cadlayerslist/applicationcodescontainer/) { get; set; } | Gets or sets the application codes container. |
| [CadSymbolTableGroupCodes](../../aspose.cad.fileformats.cad/cadlayerslist/cadsymboltablegroupcodes/) { get; set; } | Gets or sets the cad symbol table group codes. |
...
| [AddRange](../../aspose.cad.fileformats.cad/cadlayerslist/addrange/)(CadLayerTable[]) | Adds the range of the objects to container. |
| [Clear](../../aspose.cad/nongenericlist/clear/)() | Removes all items from the IList. |
| [Clone](../../aspose.cad.fileformats.cad/cadlayerslist/clone/)() | The clone. |
...
| virtual [GetLayer](../../aspose.cad.fileformats.cad/cadlayerslist/getlayer/)(string) | Gets list of layers by name. |
| [GetLayersNames](../../aspose.cad.fileformats.cad/cadlayerslist/getlayersnames/)() | Gets the layers names. |
