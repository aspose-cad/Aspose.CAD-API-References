...
public class CadLongAttribute : CadSingleValueProperty
```
...
| Name | Description |
| --- | --- |
| [CadLongAttribute](cadlongattribute/)(CadEntityAttribute, CadParameterType, string) | Initializes a new instance of the `CadLongAttribute` class. |
