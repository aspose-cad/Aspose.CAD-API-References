...
public class CadBoolAttribute : CadSingleValueProperty
```
...
| Name | Description |
| --- | --- |
| [CadBoolAttribute](cadboolattribute/)(CadEntityAttribute, CadParameterType, string) | Initializes a new instance of the `CadBoolAttribute` class. |
