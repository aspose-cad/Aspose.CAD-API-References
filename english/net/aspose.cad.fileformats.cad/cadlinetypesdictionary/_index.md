---
title: Class CadLineTypesDictionary
...
| Name | Description |
| --- | --- |
| [CadSymbolTableGroupCodes](../../aspose.cad.fileformats.cad/cadlinetypesdictionary/cadsymboltablegroupcodes/) { get; set; } | Gets or sets the cad symbol table group codes. |
...
| [Item](../../aspose.cad.fileformats.cad/cadlinetypesdictionary/item/) { get; set; } | Gets or sets the [`CadLineTypeTableObject`](../../aspose.cad.fileformats.cad.cadtables/cadlinetypetableobject/) with the specified key. (2 indexers) |
| [Keys](../../aspose.cad/nongenericdictionary/keys/) { get; } | Gets an ICollection object containing the keys of the IDictionary object. |
| [KeysTyped](../../aspose.cad.fileformats.cad/cadlinetypesdictionary/keystyped/) { get; } | Gets the strongly typed collection of keys. |
...
| [ValuesTyped](../../aspose.cad.fileformats.cad/cadlinetypesdictionary/valuestyped/) { get; } | Gets the strongly typed values collection. |
...
| [Add](../../aspose.cad.fileformats.cad/cadlinetypesdictionary/add/#add_1)(string, CadLineTypeTableObject) | Adds a [`CadLineTypeTableObject`](../../aspose.cad.fileformats.cad.cadtables/cadlinetypetableobject/) to the dictionary. |
| [Clear](../../aspose.cad/nongenericdictionary/clear/)() | Removes all elements from the IDictionary object. |
| [Clone](../../aspose.cad.fileformats.cad/cadlinetypesdictionary/clone/)() | Clones the dictionary. |
...
| [ContainsKey](../../aspose.cad.fileformats.cad/cadlinetypesdictionary/containskey/)(string) | Determines whether [`CadLineTypeTableObject`](../../aspose.cad.fileformats.cad.cadtables/cadlinetypetableobject/) contained within this dictionary. |
...
| [Remove](../../aspose.cad.fileformats.cad/cadlinetypesdictionary/remove/#remove)(string) | Removes the [`CadLineTypeTableObject`](../../aspose.cad.fileformats.cad.cadtables/cadlinetypetableobject/) with the specified key. |
| [TryGetValue](../../aspose.cad.fileformats.cad/cadlinetypesdictionary/trygetvalue/)(string, out CadLineTypeTableObject) | Gets the value associated with the specified key. |
