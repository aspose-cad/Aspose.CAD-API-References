...
| [CacheData](cachedata)() | Caches the data and ensures no additional data loading will be performed from the underlying [`DataStreamContainer`](../datastreamsupporter/datastreamcontainer). |
...
| [Resize](resize)(int, int, ImageResizeSettings) | Resizes the image. |
| [Resize](resize)(int, int, ResizeType) | Resizes the image. |
