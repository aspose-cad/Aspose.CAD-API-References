...
| override [AdjustGamma](../../aspose.cad/rastercachedimage/adjustgamma)(float) | Gamma-correction of an image. |
| override [AdjustGamma](../../aspose.cad/rastercachedimage/adjustgamma)(float, float, float) | Gamma-correction of an image. |
...
| override [Crop](../../aspose.cad/rastercachedimage/crop)(Rectangle) | Cropping the image. |
...
| override [Dither](../../aspose.cad/rastercachedimage/dither)(DitheringMethod, int, IColorPalette) | Performs dithering on the current image. |
...
| [Resize](../../aspose.cad/rastercachedimage/resize)(int, int, ImageResizeSettings) | Resizes the image. |
| [Resize](../../aspose.cad/rastercachedimage/resize)(int, int, ResizeType) | Resizes the image. |
