...
| abstract [AdjustGamma](../../aspose.cad/rasterimage/adjustgamma)(float) | Gamma-correction of an image. |
| abstract [AdjustGamma](../../aspose.cad/rasterimage/adjustgamma)(float, float, float) | Gamma-correction of an image. |
...
| abstract [Crop](../../aspose.cad/rasterimage/crop)(Rectangle) | Cropping the image. |
...
| abstract [Dither](../../aspose.cad/rasterimage/dither)(DitheringMethod, int, IColorPalette) | Performs dithering on the current image. |
...
| abstract [Resize](../../aspose.cad/rasterimage/resize)(int, int, ImageResizeSettings) | Resizes the image. |
| abstract [Resize](../../aspose.cad/rasterimage/resize)(int, int, ResizeType) | Resizes the image. |
