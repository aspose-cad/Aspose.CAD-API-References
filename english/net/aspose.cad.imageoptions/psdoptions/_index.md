...
| [ChannelBitsCount](../../aspose.cad.imageoptions/psdoptions/channelbitscount/) { get; set; } | Gets or sets the bits count per color channel. |
| [ChannelsCount](../../aspose.cad.imageoptions/psdoptions/channelscount/) { get; set; } | Gets or sets the color channels count. |
| [ColorMode](../../aspose.cad.imageoptions/psdoptions/colormode/) { get; set; } | Gets or sets the psd color mode. |
| [CompressionMethod](../../aspose.cad.imageoptions/psdoptions/compressionmethod/) { get; set; } | Gets or sets the psd compression method. |
