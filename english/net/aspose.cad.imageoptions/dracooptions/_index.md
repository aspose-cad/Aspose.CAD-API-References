---
title: Class DracoOptions
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.ImageOptions.DracoOptions class. The Draco options
type: docs
weight: 36360
url: /net/aspose.cad.imageoptions/dracooptions/
---
## DracoOptions class
...
```csharp
public class DracoOptions : ImageOptionsBase
```
...
| Name | Description |
| --- | --- |
| [DracoOptions](dracooptions/)() | The default constructor. |
...
| [PenWidth](../../aspose.cad.imageoptions/dracooptions/penwidth/) { get; set; } | Gets or sets the pen width. |
...
| override [TargetFormat](../../aspose.cad.imageoptions/dracooptions/targetformat/) { get; } |  |
