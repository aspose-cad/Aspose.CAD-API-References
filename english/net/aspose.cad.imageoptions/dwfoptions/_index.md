---
title: Class DwfOptions
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.ImageOptions.DwfOptions class. The DWF options
type: docs
weight: 36370
...
| Name | Description |
| --- | --- |
| [DwfOptions](dwfoptions/)() | Initializes a new instance of the `DwfOptions` class. |

## Properties

| Name | Description |
| --- | --- |
| [BezierPointCount](../../aspose.cad.imageoptions/dwfoptions/bezierpointcount/) { get; set; } | How many points to generate when converting Bezier curves to polylines |
...
| [MergeOptions](../../aspose.cad.imageoptions/dwfoptions/mergeoptions/) { get; set; } | Gets or sets the merge options. |
...
| [TargetDwfInterface](../../aspose.cad.imageoptions/dwfoptions/targetdwfinterface/) { get; set; } | Gets or sets target DWF interface. 0 - ePlot interface (default). 1 - eModel interface. |
