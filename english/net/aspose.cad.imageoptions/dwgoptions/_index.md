---
title: Class DwgOptions
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.ImageOptions.DwgOptions class. The DWG file format creation options
type: docs
weight: 36380
url: /net/aspose.cad.imageoptions/dwgoptions/
---
## DwgOptions class
...
```csharp
public class DwgOptions : ImageOptionsBase
```
...
| Name | Description |
| --- | --- |
| [DwgOptions](dwgoptions/)() | The default constructor. |
...
| [OutputMode](../../aspose.cad.imageoptions/dwgoptions/outputmode/) { get; set; } | Whether to convert contents to target format as is, or render to lines and then save. Convert mode is only availible for DWG\DXF source formats. |
...
| override [TargetFormat](../../aspose.cad.imageoptions/dwgoptions/targetformat/) { get; } | The target format |
