---
title: Class IfcOptions
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.ImageOptions.IfcOptions class. The STP options
type: docs
weight: 36320
...
```csharp
public class IfcOptions : ImageOptionsBase
```
...
| Name | Description |
| --- | --- |
| [IfcOptions](ifcoptions/)() | The default constructor. |
...
| override [TargetFormat](../../aspose.cad.imageoptions/ifcoptions/targetformat/) { get; } |  |
