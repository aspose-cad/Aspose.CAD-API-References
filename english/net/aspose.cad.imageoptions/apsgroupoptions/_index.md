...
```csharp
public class ApsGroupOptions : ImageOptionsBase
```
...
| Name | Description |
| --- | --- |
| [ApsGroupOptions](apsgroupoptions/)() | The default constructor. |
...
| override [TargetFormat](../../aspose.cad.imageoptions/apsgroupoptions/targetformat/) { get; } |  |
