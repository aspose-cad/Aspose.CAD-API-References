...
| [IsValid](../../aspose.cad.imageoptions/tiffoptions/isvalid) { get; } | Gets a value indicating whether the [`TiffOptions`](../tiffoptions) have been properly configured. Use Validate method as to find the failure reason. |
