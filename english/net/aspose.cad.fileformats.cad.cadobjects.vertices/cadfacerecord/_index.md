---
title: Class CadFaceRecord
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.Vertices.CadFaceRecord class. The Cad face record
type: docs
weight: 4080
...
| override [Bugle](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/bugle/) { get; set; } | Gets or sets the bugle. |
...
| override [CurveFitTangentDirection](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/curvefittangentdirection/) { get; set; } | Gets or sets the curve fit tangent direction. |
...
| override [EndingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/endingwidth/) { get; set; } | Gets or sets the ending width. |
| override [Flags](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/flags/) { get; set; } | Gets or sets the flags. |
...
| override [LocationPoint](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/locationpoint/) { get; set; } | Gets or sets the location point. |
...
| override [MeshVertexIndex1](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/meshvertexindex1/) { get; set; } | Gets or sets the mesh vertex index 1. |
| override [MeshVertexIndex2](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/meshvertexindex2/) { get; set; } | Gets or sets the mesh vertex index 2. |
| override [MeshVertexIndex3](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/meshvertexindex3/) { get; set; } | Gets or sets the mesh vertex index 3. |
| override [MeshVertexIndex4](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/meshvertexindex4/) { get; set; } | Gets or sets the mesh vertex index 4. |
...
| override [StartingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/startingwidth/) { get; set; } | Gets or sets the starting width. |
...
| override [VertexId](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadfacerecord/vertexid/) { get; set; } | Gets or sets the vertex id. |
