...
```csharp
public class CadCircle : CadExtrudedEntityBase, IAnnotateable
```
...
| [DefaultPoint](../../aspose.cad.fileformats.cad.cadobjects/cadcircle/defaultpoint/) { get; } | Gets the default point. |
...
* interface [IAnnotateable](../../aspose.cad.annotations/iannotateable/)
