---
title: Class CadExtrudedSurface
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadExtrudedSurface class. The Cad revolved surface
type: docs
weight: 2540
...
| Name | Description |
| --- | --- |
| [CadExtrudedSurface](cadextrudedsurface/)() | Initializes a new instance of the `CadExtrudedSurface` class. |

## Properties

| Name | Description |
| --- | --- |
| [AlignAngle](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/alignangle/) { get; set; } | Gets or sets the align angle. |
| [AlignStartFlag](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/alignstartflag/) { get; set; } | Gets or sets the align start flag. |
...
| [BankFlag](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/bankflag/) { get; set; } | Gets or sets the bank flag. |
| [BasePointSetFlag](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/basepointsetflag/) { get; set; } | Gets or sets the base point set flag. |
| [BinaryDataSize](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/binarydatasize/) { get; set; } | Gets or sets the size of the binary data. |
...
| [ClassId](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/classid/) { get; set; } | Gets or sets the class identifier. |
...
| [DraftAngle](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/draftangle/) { get; set; } | Gets or sets the draft angle. |
...
| [EndDraftDistance](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/enddraftdistance/) { get; set; } | Gets or sets the end draft distance. |
| [ExtrudedSurfaceBinaryData](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/extrudedsurfacebinarydata/) { get; set; } | Gets or sets the extruded surface binary data. |
...
| [PathEntityTransformComputedFlag](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/pathentitytransformcomputedflag/) { get; set; } | Gets or sets the path entity transform computed flag. |
...
| [ReferenceVector](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/referencevector/) { get; set; } | Gets or sets reference vector. |
| [ScaleFactor](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/scalefactor/) { get; set; } | Gets or sets the scale factor. |
...
| [SolidFlag](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/solidflag/) { get; set; } | Gets or sets a value indicating whether solid flag. |
...
| [StartDraftDistance](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/startdraftdistance/) { get; set; } | Gets or sets the start draft distance. |
...
| [SweepAlignmentOption](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/sweepalignmentoption/) { get; set; } | Gets or sets the sweep alignment option. |
| [SweepEntityTransformComputedFlag](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/sweepentitytransformcomputedflag/) { get; set; } | Gets or sets the sweep entity transform computed flag. |
| [SweepVector](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/sweepvector/) { get; set; } | Gets or sets sweep vector. |
| [TransformMatrix](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/transformmatrix/) { get; set; } | Gets or sets the transform matrix. |
| [TransformMatrixPath](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/transformmatrixpath/) { get; set; } | Gets or sets path of transform matrix. |
| [TransformMatrixSweep](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/transformmatrixsweep/) { get; set; } | Gets or sets sweep of transform matrix. |
...
| [TwistAngle](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/twistangle/) { get; set; } | Gets or sets the twist angle. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedsurface/typename/) { get; } | Gets the name of the type. |
