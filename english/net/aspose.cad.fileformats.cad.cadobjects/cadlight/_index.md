...
```csharp
public class CadLight : CadEntityBase
```
...
| Name | Description |
| --- | --- |
| [CadLight](cadlight/)() | Initializes a new instance of the `CadLight` class. |
...
| [AttenuationStartLimit](../../aspose.cad.fileformats.cad.cadobjects/cadlight/attenuationstartlimit/) { get; set; } | Gets or sets the attenuation start limit. |
| [AttenuationType](../../aspose.cad.fileformats.cad.cadobjects/cadlight/attenuationtype/) { get; set; } | Gets or sets the type of the attenuation. |
...
| [Attribute421](../../aspose.cad.fileformats.cad.cadobjects/cadlight/attribute421/) { get; set; } | Gets or sets the attribute 421. |
| [Attribute63](../../aspose.cad.fileformats.cad.cadobjects/cadlight/attribute63/) { get; set; } | Gets or sets the attribute 63. |
...
| [CastShadows](../../aspose.cad.fileformats.cad.cadobjects/cadlight/castshadows/) { get; set; } | Gets or sets a value indicating whether [cast shadows]. |
...
| [FalloffAngle](../../aspose.cad.fileformats.cad.cadobjects/cadlight/falloffangle/) { get; set; } | Gets or sets the falloff angle. |
| [HardOwner](../../aspose.cad.fileformats.cad.cadobjects/cadownedobjectbase/hardowner/) { get; set; } | Gets or sets the hard owner. |
| [HotspotAngle](../../aspose.cad.fileformats.cad.cadobjects/cadlight/hotspotangle/) { get; set; } | Gets or sets the hotspot angle. |
...
| [IntenSity](../../aspose.cad.fileformats.cad.cadobjects/cadlight/intensity/) { get; set; } | Gets or sets the inten sity. |
...
| [PlotGlyph](../../aspose.cad.fileformats.cad.cadobjects/cadlight/plotglyph/) { get; set; } | Gets or sets a value indicating whether [plot glyph]. |
...
| [ShadowMapSize](../../aspose.cad.fileformats.cad.cadobjects/cadlight/shadowmapsize/) { get; set; } | Gets or sets the size of the shadow map. |
| [ShadowMapSoftness](../../aspose.cad.fileformats.cad.cadobjects/cadlight/shadowmapsoftness/) { get; set; } | Gets or sets the shadow map softness. |
| [ShadowMode](../../aspose.cad.fileformats.cad.cadobjects/cadentitybase/shadowmode/) { get; set; } | Gets or sets the shadow mode. |
| [ShadowType](../../aspose.cad.fileformats.cad.cadobjects/cadlight/shadowtype/) { get; set; } | Gets or sets the type of the shadow. |
...
| [VersionNumber](../../aspose.cad.fileformats.cad.cadobjects/cadlight/versionnumber/) { get; set; } | Gets or sets the version number. |
