...
```csharp
public class CadMLeaderLine : CadEntityBase
```
...
| Name | Description |
| --- | --- |
| [CadMLeaderLine](cadmleaderline/)() | Initializes a new instance of the `CadMLeaderLine` class. |
...
| [ArrowSize](../../aspose.cad.fileformats.cad.cadobjects/cadmleaderline/arrowsize/) { get; set; } | Gets or sets the arrow size. |
...
| [BreakEndPoint](../../aspose.cad.fileformats.cad.cadobjects/cadmleaderline/breakendpoint/) { get; set; } | Gets or sets the break end point. |
...
| [Flags](../../aspose.cad.fileformats.cad.cadobjects/cadmleaderline/flags/) { get; set; } | Gets or sets the flags. |
...
| [LeaderLineIndex](../../aspose.cad.fileformats.cad.cadobjects/cadmleaderline/leaderlineindex/) { get; set; } | Gets or sets the index of the leader line. |
| [LeaderPoints](../../aspose.cad.fileformats.cad.cadobjects/cadmleaderline/leaderpoints/) { get; set; } | Gets or sets the leaderPoints. |
| [LeaderType](../../aspose.cad.fileformats.cad.cadobjects/cadmleaderline/leadertype/) { get; set; } | Gets or sets the leader type. |
...
| [Parameters](../../aspose.cad.fileformats.cad.cadobjects/cadmleaderline/parameters/) { get; set; } | Gets or sets the parameters list. |
...
| [Weight](../../aspose.cad.fileformats.cad.cadobjects/cadmleaderline/weight/) { get; set; } | Gets or sets the line weight. |
