...
```csharp
public class CadLeader : CadEntityBase
```
...
| Name | Description |
| --- | --- |
| [CadLeader](cadleader/)() | Initializes a new instance of the `CadLeader` class. |

## Properties

| Name | Description |
| --- | --- |
| [AnnotationPlacementPointOffset](../../aspose.cad.fileformats.cad.cadobjects/cadleader/annotationplacementpointoffset/) { get; set; } | Gets or sets offset of last leader vertex from annotation placement point |
| [AnnotType](../../aspose.cad.fileformats.cad.cadobjects/cadleader/annottype/) { get; set; } | Gets or sets the annot type. |
...
| [ArrowHeadFlag](../../aspose.cad.fileformats.cad.cadobjects/cadleader/arrowheadflag/) { get; set; } | Gets or sets the arrowhead flag. |
| [AssociatedAnnotation](../../aspose.cad.fileformats.cad.cadobjects/cadleader/associatedannotation/) { get; set; } | Gets or sets reference to associated annotation object. |
...
| [Coordinates](../../aspose.cad.fileformats.cad.cadobjects/cadleader/coordinates/) { get; set; } | Gets or sets the coordinates. |
| [CreationFlag](../../aspose.cad.fileformats.cad.cadobjects/cadleader/creationflag/) { get; set; } | Gets or sets the type of path. |
...
| [EndPointPrj](../../aspose.cad.fileformats.cad.cadobjects/cadleader/endpointprj/) { get; set; } | Gets or sets the end point prj |
| [Extrusion](../../aspose.cad.fileformats.cad.cadobjects/cadleader/extrusion/) { get; set; } | Gets or sets the extrusion |
| [HardOwner](../../aspose.cad.fileformats.cad.cadobjects/cadownedobjectbase/hardowner/) { get; set; } | Gets or sets the hard owner. |
| [HookLineCreationFlag](../../aspose.cad.fileformats.cad.cadobjects/cadleader/hooklinecreationflag/) { get; set; } | Gets or sets the hook line creation flag. |
| [HookLineFlag](../../aspose.cad.fileformats.cad.cadobjects/cadleader/hooklineflag/) { get; set; } | Gets or sets the hook line flag. |
| [HorizontalDirection](../../aspose.cad.fileformats.cad.cadobjects/cadleader/horizontaldirection/) { get; set; } | Gets or sets the horizontal direction. |
...
| [LastLeaderVertex](../../aspose.cad.fileformats.cad.cadobjects/cadleader/lastleadervertex/) { get; set; } | Gets or sets the last leader vertex. |
...
| [LeaderColor](../../aspose.cad.fileformats.cad.cadobjects/cadleader/leadercolor/) { get; set; } | Gets or sets the color of the leader. |
...
| [NormalVector](../../aspose.cad.fileformats.cad.cadobjects/cadleader/normalvector/) { get; set; } | Gets or sets normal vector |
...
| [OffsetBlock](../../aspose.cad.fileformats.cad.cadobjects/cadleader/offsetblock/) { get; set; } | Gets or sets the offset block |
| [PathType](../../aspose.cad.fileformats.cad.cadobjects/cadleader/pathtype/) { get; set; } | Gets or sets the type of path. |
...
| [StyleType](../../aspose.cad.fileformats.cad.cadobjects/cadleader/styletype/) { get; set; } | Gets or sets the style type. |
| [TextHeight](../../aspose.cad.fileformats.cad.cadobjects/cadleader/textheight/) { get; set; } | Gets or sets the text height. |
| [TextWidth](../../aspose.cad.fileformats.cad.cadobjects/cadleader/textwidth/) { get; set; } | Gets or sets the scale x. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadleader/typename/) { get; } | Gets the name of the type. |
| [VerticesCount](../../aspose.cad.fileformats.cad.cadobjects/cadleader/verticescount/) { get; set; } | Gets or sets the count of vertices. |
