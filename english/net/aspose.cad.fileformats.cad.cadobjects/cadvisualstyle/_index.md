...
| Name | Description |
| --- | --- |
| [CadVisualStyle](cadvisualstyle/)() | Initializes a new instance of the `CadVisualStyle` class. |
...
| [Color2](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/color2/) { get; set; } | Gets or sets the color2. |
| [Description](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/description/) { get; set; } | Gets or sets the description. |
| [DisplayStyleDisplaySettings](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/displaystyledisplaysettings/) { get; set; } | Gets or sets the display style display settings. |
| [EdgeColor](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgecolor/) { get; set; } | Gets or sets the color of the edge. |
| [EdgeCreaseAngle](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgecreaseangle/) { get; set; } | Gets or sets the edge crease angle. |
| [EdgeHaloGap](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgehalogap/) { get; set; } | Gets or sets the edge halo gap. |
| [EdgeHidePrecisionFlag](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgehideprecisionflag/) { get; set; } | Gets or sets the edge hide precision flag. |
| [EdgeIntersectionColor](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgeintersectioncolor/) { get; set; } | Gets or sets the color of the edge intersection. |
| [EdgeIntersectionLinetype](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgeintersectionlinetype/) { get; set; } | Gets or sets the edge intersection linetype. |
| [EdgeIsolinesNumber](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgeisolinesnumber/) { get; set; } | Gets or sets the edge isolines number. |
| [EdgeJitter](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgejitter/) { get; set; } | Gets or sets the edge jitter. |
| [EdgeModifiers](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgemodifiers/) { get; set; } | Gets or sets the edge modifiers. |
| [EdgeObscuredColor](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgeobscuredcolor/) { get; set; } | Gets or sets the color of the edge obscured. |
| [EdgeObscuredLinetype](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgeobscuredlinetype/) { get; set; } | Gets or sets the edge obscured linetype. |
| [EdgeOpacityLevel](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgeopacitylevel/) { get; set; } | Gets or sets the edge opacity level. |
| [EdgeOverhang](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgeoverhang/) { get; set; } | Gets or sets the edge overhang. |
| [EdgeSilhouetteColor](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgesilhouettecolor/) { get; set; } | Gets or sets the color of the edge silhouette. |
| [EdgeSilhouetteWidth](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgesilhouettewidth/) { get; set; } | Gets or sets the width of the edge silhouette. |
| [EdgeStyle](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/edgestyle/) { get; set; } | Gets or sets the edge style. |
...
| [FaceModifiers](../../aspose.cad.fileformats.cad.cadobjects/cadvisualstyle/facemodifiers/) { get; set; } | Gets or sets the face modifiers. |
