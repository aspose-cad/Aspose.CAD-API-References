---
title: Class CadAcshSphereClass
...
```csharp
public class CadAcshSphereClass : CadDbEvalExpr
```
...
| Name | Description |
| --- | --- |
| [CadAcshSphereClass](cadacshsphereclass/)() | Initializes a new instance of the `CadAcshSphereClass` class. |
...
| [HistoryNode](../../aspose.cad.fileformats.cad.cadobjects/cadacshsphereclass/historynode/) { get; set; } | The HistoryNode |
...
| [Major](../../aspose.cad.fileformats.cad.cadobjects/cadacshsphereclass/major/) { get; set; } | The major |
| [Minor](../../aspose.cad.fileformats.cad.cadobjects/cadacshsphereclass/minor/) { get; set; } | The minor |
...
| [Radius](../../aspose.cad.fileformats.cad.cadobjects/cadacshsphereclass/radius/) { get; set; } | The radius |
