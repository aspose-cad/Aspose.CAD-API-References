...
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadMesh class. Class describing CadMesh
type: docs
weight: 2910
...
```csharp
public class CadMesh : CadEntityBase
```
...
| Name | Description |
| --- | --- |
| [CadMesh](cadmesh/)() | Initializes a new instance of the `CadMesh` class. |
...
| [BlendCase](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/blendcase/) { get; set; } | Gets or sets blend case |
...
| [EdgeCount](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/edgecount/) { get; set; } | Gets or sets edge count |
| [EdgeCreaseCount](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/edgecreasecount/) { get; set; } | Gets or sets the edge crease count. |
| [EdgeCreateValues](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/edgecreatevalues/) { get; set; } | Gets or sets the edge create values. |
...
| [FaceListItems](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/facelistitems/) { get; set; } | Gets or sets face list |
...
| [OverriddenPropertyCount](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/overriddenpropertycount/) { get; set; } | Gets or sets the overridden property count. |
...
| [PropertyTypes](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/propertytypes/) { get; set; } | Gets or sets the property types. |
...
| [SizeOfFaceList](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/sizeoffacelist/) { get; set; } | Gets or sets size of face list |
...
| [SubdivisionLevelNumber](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/subdivisionlevelnumber/) { get; set; } | Gets or sets the subdivision level number. |
| [SubEntityCount](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/subentitycount/) { get; set; } | Gets or sets the sub entity count. |
| [SubEntityMarkers](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/subentitymarkers/) { get; set; } | Gets or sets the sub entity markers. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/typename/) { get; } | Gets the name of the type. |
| [VersionNumber](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/versionnumber/) { get; set; } | Gets or sets version number |
| [VertexCount](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/vertexcount/) { get; set; } | Gets or sets vertex count |
| [VertexIndices](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/vertexindices/) { get; set; } | Gets or sets vertex indices |
| [Vertices](../../aspose.cad.fileformats.cad.cadobjects/cadmesh/vertices/) { get; set; } | Gets or sets vertices |
