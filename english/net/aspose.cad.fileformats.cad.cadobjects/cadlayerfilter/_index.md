...
| Name | Description |
| --- | --- |
| [CadLayerFilter](cadlayerfilter/)() | Initializes a new instance of the `CadLayerFilter` class. |
...
| [LayerNames](../../aspose.cad.fileformats.cad.cadobjects/cadlayerfilter/layernames/) { get; set; } | Gets or sets the layer names. |
