---
title: Class CadRasterImageData
...
| [BitsPerSample](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedata/bitspersample/) { get; set; } | Gets or sets bits per samples. |
| [ChildObjects](../../aspose.cad.fileformats.cad.cadobjects/cadbaseobject/childobjects/) { get; set; } | Gets or sets the child objects. |
| [Compression](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedata/compression/) { get; set; } | Gets or sets compression. |
...
| [FileName](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedata/filename/) { get; set; } | Gets or sets name of a file. |
| [FileType](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedata/filetype/) { get; set; } | Gets or sets type of a file. |
| [HardOwner](../../aspose.cad.fileformats.cad.cadobjects/cadownedobjectbase/hardowner/) { get; set; } | Gets or sets the hard owner. |
| [ImageData](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedata/imagedata/) { get; set; } | Gets or sets image data. |
| [ImageSizeU](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedata/imagesizeu/) { get; set; } | Gets or sets image size U. |
| [ImageSizeV](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedata/imagesizev/) { get; set; } | Gets or sets image size V. |
...
| [PhotometricInterpretation](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedata/photometricinterpretation/) { get; set; } | Gets or sets Photometric Interpretation. |
| [PlanarConfiguration](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedata/planarconfiguration/) { get; set; } | Gets or sets Planar Configuration. |
| [Reactors](../../aspose.cad.fileformats.cad.cadobjects/cadownedobjectbase/reactors/) { get; set; } | Get or sets the reactors handle |
| [Resolution](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedata/resolution/) { get; set; } | Gets or sets resolution. |
| [ResolutionUnits](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedata/resolutionunits/) { get; set; } | Gets or sets resolution units. 1 - inch 4 - millimeters 5 - centimeters |
...
| [XResolution](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedata/xresolution/) { get; set; } | Gets or sets XResolution. |
