---
title: Class CadUnderlay
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadUnderlay class. Class describing CadUnderlay
type: docs
weight: 3250
...
```csharp
public class CadUnderlay : CadExtrudedEntityBase
```
...
| Name | Description |
| --- | --- |
| [CadUnderlay](cadunderlay/)() | Initializes a new instance of the `CadUnderlay` class. |
