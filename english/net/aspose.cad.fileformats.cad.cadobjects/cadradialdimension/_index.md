---
title: Class CadRadialDimension
...
| Name | Description |
| --- | --- |
| [CadRadialDimension](cadradialdimension/)() | Initializes a new instance of the `CadRadialDimension` class. |
...
| [RadiusDefinitionPoint](../../aspose.cad.fileformats.cad.cadobjects/cadradialdimension/radiusdefinitionpoint/) { get; set; } | Gets or sets the radius definition point. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadradialdimension/typename/) { get; } | Gets the name of the type. |
