...
| Name | Description |
| --- | --- |
| [CadBreakData](cadbreakdata/)() | Initializes a new instance of the `CadBreakData` class. |
...
| [BreakPointRefList](../../aspose.cad.fileformats.cad.cadobjects/cadbreakdata/breakpointreflist/) { get; set; } | Gets or sets the break point reference list. |
