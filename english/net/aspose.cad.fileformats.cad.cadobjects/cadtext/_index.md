...
```csharp
public class CadText : CadExtrudedEntityBase
```
...
| Name | Description |
| --- | --- |
| [CadText](cadtext/)() | Initializes a new instance of the `CadText` class. |
...
| [DefaultValue](../../aspose.cad.fileformats.cad.cadobjects/cadtext/defaultvalue/) { get; set; } | Gets or sets the default value. |
...
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects/cadtext/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
| [FirstAlignment](../../aspose.cad.fileformats.cad.cadobjects/cadtext/firstalignment/) { get; set; } | Gets or sets the first alignment. |
| [GenerationFlag](../../aspose.cad.fileformats.cad.cadobjects/cadtext/generationflag/) { get; set; } | Gets or sets the generation flag. |
| [HardOwner](../../aspose.cad.fileformats.cad.cadobjects/cadownedobjectbase/hardowner/) { get; set; } | Gets or sets the hard owner. |
| [HorizontalJustification](../../aspose.cad.fileformats.cad.cadobjects/cadtext/horizontaljustification/) { get; set; } | Gets or sets the horizontal justification. |
...
| [ObliqueAngle](../../aspose.cad.fileformats.cad.cadobjects/cadtext/obliqueangle/) { get; set; } | Gets or sets the oblique angle. |
...
| [ScaleX](../../aspose.cad.fileformats.cad.cadobjects/cadtext/scalex/) { get; set; } | Gets or sets the scale x. |
| [SecondAlignmentPoint](../../aspose.cad.fileformats.cad.cadobjects/cadtext/secondalignmentpoint/) { get; set; } | Gets or sets the second alignment point. |
...
| [StyleType](../../aspose.cad.fileformats.cad.cadobjects/cadtext/styletype/) { get; set; } | Gets or sets the style type. |
| [TextHeight](../../aspose.cad.fileformats.cad.cadobjects/cadtext/textheight/) { get; set; } | Gets or sets the text height. |
| [TextRotation](../../aspose.cad.fileformats.cad.cadobjects/cadtext/textrotation/) { get; set; } | Gets or sets the text rotation. |
| [TextWidth](../../aspose.cad.fileformats.cad.cadobjects/cadtext/textwidth/) { get; } | Gets the text width. |
| [Thickness](../../aspose.cad.fileformats.cad.cadobjects/cadtext/thickness/) { get; set; } | Gets or sets the thickness. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadtext/typename/) { get; } | Gets the name of the type. |
| [VerticalJustification](../../aspose.cad.fileformats.cad.cadobjects/cadtext/verticaljustification/) { get; set; } | Gets or sets the vertical justification. |
