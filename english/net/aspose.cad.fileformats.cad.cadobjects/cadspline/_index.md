...
```csharp
public class CadSpline : CadEntityBase
```
...
| Name | Description |
| --- | --- |
| [CadSpline](cadspline/)() | Initializes a new instance of the `CadSpline` class. |
...
| [Closed](../../aspose.cad.fileformats.cad.cadobjects/cadspline/closed/) { get; set; } | Gets or sets the closed |
...
| [ControlPoints](../../aspose.cad.fileformats.cad.cadobjects/cadspline/controlpoints/) { get; set; } | Gets or sets the control points. |
| [ControlPointsNumber](../../aspose.cad.fileformats.cad.cadobjects/cadspline/controlpointsnumber/) { get; set; } | Gets or sets the control points number. |
| [ControlPointTolerance](../../aspose.cad.fileformats.cad.cadobjects/cadspline/controlpointtolerance/) { get; set; } | Gets or sets the control point tolerance. |
| [CurveDegree](../../aspose.cad.fileformats.cad.cadobjects/cadspline/curvedegree/) { get; set; } | Gets or sets the curve degree. |
| [Degree](../../aspose.cad.fileformats.cad.cadobjects/cadspline/degree/) { get; set; } | Gets or sets the degree. |
...
| [EndTangent](../../aspose.cad.fileformats.cad.cadobjects/cadspline/endtangent/) { get; set; } | Gets or sets the end tangent. |
| [FitPoints](../../aspose.cad.fileformats.cad.cadobjects/cadspline/fitpoints/) { get; set; } | Gets or sets the fit points. |
| [FitPointsNumber](../../aspose.cad.fileformats.cad.cadobjects/cadspline/fitpointsnumber/) { get; set; } | Gets or sets the fit points number. |
| [FitTolerance](../../aspose.cad.fileformats.cad.cadobjects/cadspline/fittolerance/) { get; set; } | Gets or sets the fit tolerance. |
...
| [KnotsNumber](../../aspose.cad.fileformats.cad.cadobjects/cadspline/knotsnumber/) { get; set; } | Gets or sets the knots number. |
| [KnotTolerance](../../aspose.cad.fileformats.cad.cadobjects/cadspline/knottolerance/) { get; set; } | Gets or sets the knot tolerance. |
| [KnotValues](../../aspose.cad.fileformats.cad.cadobjects/cadspline/knotvalues/) { get; set; } | Gets or sets the knot values. |
...
| [NormalVector](../../aspose.cad.fileformats.cad.cadobjects/cadspline/normalvector/) { get; set; } | Gets or sets the normal vector |
...
| [Periodirc](../../aspose.cad.fileformats.cad.cadobjects/cadspline/periodirc/) { get; set; } | Gets or sets the periodic |
...
| [Rational](../../aspose.cad.fileformats.cad.cadobjects/cadspline/rational/) { get; set; } | Gets or sets the rational |
| [Reactors](../../aspose.cad.fileformats.cad.cadobjects/cadownedobjectbase/reactors/) { get; set; } | Get or sets the reactors handle |
| [Scenario](../../aspose.cad.fileformats.cad.cadobjects/cadspline/scenario/) { get; set; } | Gets or sets the scenario |
...
| [Weight](../../aspose.cad.fileformats.cad.cadobjects/cadspline/weight/) { get; set; } | Gets or sets the weight |
| [WeightParams](../../aspose.cad.fileformats.cad.cadobjects/cadspline/weightparams/) { get; set; } | Gets or sets the weight parameter |
