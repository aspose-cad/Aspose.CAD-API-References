---
title: Class CadAcshCylinderClass
...
```csharp
public class CadAcshCylinderClass : CadDbEvalExpr
```
...
| Name | Description |
| --- | --- |
| [CadAcshCylinderClass](cadacshcylinderclass/)() | Initializes a new instance of the `CadAcshCylinderClass` class. |
...
| [Height](../../aspose.cad.fileformats.cad.cadobjects/cadacshcylinderclass/height/) { get; set; } | The height |
| [HistoryNode](../../aspose.cad.fileformats.cad.cadobjects/cadacshcylinderclass/historynode/) { get; set; } | The HistoryNode |
...
| [Major](../../aspose.cad.fileformats.cad.cadobjects/cadacshcylinderclass/major/) { get; set; } | The major |
| [MajorRadius](../../aspose.cad.fileformats.cad.cadobjects/cadacshcylinderclass/majorradius/) { get; set; } | The major radius |
| [Minor](../../aspose.cad.fileformats.cad.cadobjects/cadacshcylinderclass/minor/) { get; set; } | The minor |
| [MinorRadius](../../aspose.cad.fileformats.cad.cadobjects/cadacshcylinderclass/minorradius/) { get; set; } | The minor radius |
...
| [Radius](../../aspose.cad.fileformats.cad.cadobjects/cadacshcylinderclass/radius/) { get; set; } | The radius |
