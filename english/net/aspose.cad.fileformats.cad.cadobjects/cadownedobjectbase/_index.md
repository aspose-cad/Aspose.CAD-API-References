---
title: Class CadOwnedObjectBase
...
```csharp
public abstract class CadOwnedObjectBase : CadObjectBase
```
...
| Name | Description |
| --- | --- |
| [CadOwnedObjectBase](cadownedobjectbase/)() | Initializes a new instance of the `CadOwnedObjectBase` class. |
