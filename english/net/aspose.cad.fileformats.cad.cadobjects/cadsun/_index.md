...
| [Color](../../aspose.cad.fileformats.cad.cadobjects/cadsun/color/) { get; set; } | Gets or sets the color. |
...
| [DaylightSavings](../../aspose.cad.fileformats.cad.cadobjects/cadsun/daylightsavings/) { get; set; } | Gets or sets a value indicating whether daylight savings. |
...
| [Intensity](../../aspose.cad.fileformats.cad.cadobjects/cadsun/intensity/) { get; set; } | Gets or sets the intensity. |
...
| [JulianDay](../../aspose.cad.fileformats.cad.cadobjects/cadsun/julianday/) { get; set; } | Gets or sets the julian day. |
...
| [ShadowMapSize](../../aspose.cad.fileformats.cad.cadobjects/cadsun/shadowmapsize/) { get; set; } | Gets or sets the shadow map size. |
| [ShadowMode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/shadowmode/) { get; set; } | Gets or sets the shadow mode. |
| [Shadows](../../aspose.cad.fileformats.cad.cadobjects/cadsun/shadows/) { get; set; } | Gets or sets a value indicating whether shadows. |
| [ShadowSoftness](../../aspose.cad.fileformats.cad.cadobjects/cadsun/shadowsoftness/) { get; set; } | Gets or sets the shadow softness. |
| [ShadowType](../../aspose.cad.fileformats.cad.cadobjects/cadsun/shadowtype/) { get; set; } | Gets or sets the shadow type. |
...
| [Status](../../aspose.cad.fileformats.cad.cadobjects/cadsun/status/) { get; set; } | Gets or sets a value indicating whether status. |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag/) { get; set; } | The StorageFlag |
| [Time](../../aspose.cad.fileformats.cad.cadobjects/cadsun/time/) { get; set; } | Gets or sets the time. |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadsun/typename/) { get; } | Gets the name of the type. |
| [VersionNumber](../../aspose.cad.fileformats.cad.cadobjects/cadsun/versionnumber/) { get; set; } | Gets or sets the version number. |
