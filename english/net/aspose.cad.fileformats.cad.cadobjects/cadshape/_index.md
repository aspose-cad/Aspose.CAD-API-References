---
title: Class CadShape
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadShape class. The Cad surface
type: docs
weight: 3170
...
```csharp
public class CadShape : CadExtrudedEntityBase
```
...
| Name | Description |
| --- | --- |
| [CadShape](cadshape/)() | Initializes a new instance of the `CadShape` class. |
...
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects/cadshape/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
...
| [InsertionPoint](../../aspose.cad.fileformats.cad.cadobjects/cadshape/insertionpoint/) { get; set; } | Gets or sets the insertion point. |
...
| [Name](../../aspose.cad.fileformats.cad.cadobjects/cadshape/name/) { get; set; } | Gets or sets the name. |
...
| [ObliqueAngle](../../aspose.cad.fileformats.cad.cadobjects/cadshape/obliqueangle/) { get; set; } | Gets or sets the oblique angle. |
...
| [RotationAngle](../../aspose.cad.fileformats.cad.cadobjects/cadshape/rotationangle/) { get; set; } | Gets or sets the rotation angle. |
| [ShadowMode](../../aspose.cad.fileformats.cad.cadobjects/cadentitybase/shadowmode/) { get; set; } | Gets or sets the shadow mode. |
| [Size](../../aspose.cad.fileformats.cad.cadobjects/cadshape/size/) { get; set; } | Gets or sets the size. |
...
| [Thickness](../../aspose.cad.fileformats.cad.cadobjects/cadshape/thickness/) { get; set; } | Gets or sets the thickness. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadshape/typename/) { get; } | Gets the name of the type. |
...
| [XScale](../../aspose.cad.fileformats.cad.cadobjects/cadshape/xscale/) { get; set; } | Gets or sets the x scale. |
