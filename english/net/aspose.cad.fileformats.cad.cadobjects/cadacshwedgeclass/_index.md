...
```csharp
public class CadAcshWedgeClass : CadDbEvalExpr
```
...
| Name | Description |
| --- | --- |
| [CadAcshWedgeClass](cadacshwedgeclass/)() | Initializes a new instance of the `CadAcshWedgeClass` class. |
...
| [Height](../../aspose.cad.fileformats.cad.cadobjects/cadacshwedgeclass/height/) { get; set; } | The height |
| [HistoryNode](../../aspose.cad.fileformats.cad.cadobjects/cadacshwedgeclass/historynode/) { get; set; } | The HistoryNode |
...
| [Length](../../aspose.cad.fileformats.cad.cadobjects/cadacshwedgeclass/length/) { get; set; } | The length |
| [Major](../../aspose.cad.fileformats.cad.cadobjects/cadacshwedgeclass/major/) { get; set; } | The major |
| [Minor](../../aspose.cad.fileformats.cad.cadobjects/cadacshwedgeclass/minor/) { get; set; } | The minor |
...
| [Width](../../aspose.cad.fileformats.cad.cadobjects/cadacshwedgeclass/width/) { get; set; } | The width |
