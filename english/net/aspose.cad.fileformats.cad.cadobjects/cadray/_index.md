...
| Name | Description |
| --- | --- |
| [CadRay](cadray/)(Cad3DPoint, Cad3DPoint) | Initializes a new instance of the `CadRay` class. |
...
| override [FirstPoint](../../aspose.cad.fileformats.cad.cadobjects/cadray/firstpoint/) { get; set; } | Gets or sets the first point . |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadray/typename/) { get; } | Gets the name of the type. |
| override [UnitDirectionVector](../../aspose.cad.fileformats.cad.cadobjects/cadray/unitdirectionvector/) { get; set; } | Gets or sets the unit direction vector. |
