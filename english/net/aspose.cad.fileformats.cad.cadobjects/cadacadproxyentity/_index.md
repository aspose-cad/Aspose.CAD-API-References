---
title: Class CadAcadProxyEntity
...
```csharp
public class CadAcadProxyEntity : CadEntityBase
```
...
| Name | Description |
| --- | --- |
| [CadAcadProxyEntity](cadacadproxyentity/)() | Initializes a new instance of the `CadAcadProxyEntity` class. |
...
| [ApplicationEntityClassId](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/applicationentityclassid/) { get; set; } | Gets or sets the application entity class identifier. |
...
| [BinaryDataAttribute311](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/binarydataattribute311/) { get; set; } | Gets or sets the binary data attribute 311. |
| [BinaryDataSize](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/binarydatasize/) { get; set; } | Gets or sets the size of the binary data. |
| [BinaryEntityData](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/binaryentitydata/) { get; set; } | Gets or sets the binary entity data. |
| [BinaryGraphicsData](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/binarygraphicsdata/) { get; set; } | Gets or sets the binary graphics data. |
...
| [CustomObjectDataFormat](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/customobjectdataformat/) { get; set; } | Gets or sets the custom object data format. |
...
| [EntityDataSizeAttribute161](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/entitydatasizeattribute161/) { get; set; } | Gets or sets the entity data size attribute161. |
| [EntityDataSizeAttribute93](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/entitydatasizeattribute93/) { get; set; } | Gets or sets the entity data size attribute93. |
| [GraphicsDataSizeAttribute160](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/graphicsdatasizeattribute160/) { get; set; } | Gets or sets the graphics data size attribute160. |
| [GraphicsDataSizeAttribute92](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/graphicsdatasizeattribute92/) { get; set; } | Gets or sets the size of the graphics data. |
...
| [ObjectDrawingFormat](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/objectdrawingformat/) { get; set; } | Gets or sets the object drawing format. |
| [ObjectHandle](../../aspose.cad.fileformats.cad.cadobjects/cadobjectbase/objecthandle/) { get; set; } | Gets or sets the object handle. |
| [ObjectId330](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/objectid330/) { get; set; } | Gets or sets the object id330. |
| [ObjectId340](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/objectid340/) { get; set; } | Gets or sets the object id 340. |
| [ObjectId350](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/objectid350/) { get; set; } | Gets or sets the object id 350. |
| [ObjectId360](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/objectid360/) { get; set; } | Gets or sets the object id 360. |
| [ObjectIdSectionEnd](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/objectidsectionend/) { get; set; } | Gets or sets the object identifier section end. |
...
| [ProxyEntityClassId](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/proxyentityclassid/) { get; set; } | Gets or sets the proxy entity class identifier. |
...
| [SubClassName](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/subclassname/) { get; set; } | The SubClassName |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadacadproxyentity/typename/) { get; } | Gets the name of the type. |
