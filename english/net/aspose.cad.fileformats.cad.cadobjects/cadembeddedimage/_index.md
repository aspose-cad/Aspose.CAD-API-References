...
```csharp
public class CadEmbeddedImage : CadRasterImage
```
...
| Name | Description |
| --- | --- |
| [CadEmbeddedImage](cadembeddedimage/)(CadRasterImageDef, Cad3DPoint, Cad3DPoint, Cad3DPoint) | Initializes a new instance of the [`CadRasterImage`](../cadrasterimage/) class. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadembeddedimage/typename/) { get; } | Gets the name of the type. |
