...
```csharp
public class CadBlockNameEntity : CadEntityBase
```
...
| [BlockName](../../aspose.cad.fileformats.cad.cadobjects/cadblocknameentity/blockname/) { get; set; } | Gets or sets the name of the block. |
