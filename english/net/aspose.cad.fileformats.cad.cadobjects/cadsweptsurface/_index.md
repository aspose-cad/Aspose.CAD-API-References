...
| Name | Description |
| --- | --- |
| [CadSweptSurface](cadsweptsurface/)() | Initializes a new instance of the `CadSweptSurface` class. |
...
| [BankFlag](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/bankflag/) { get; set; } | Gets or sets a value indicating whether bank flag. |
...
| [DraftAngle](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/draftangle/) { get; set; } | Gets or sets the draft angle. |
| [DraftEndDistance](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/draftenddistance/) { get; set; } | Gets or sets the draft end distance. |
| [DraftStartDistance](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/draftstartdistance/) { get; set; } | Gets or sets the draft start distance. |
...
| [PathEntityID](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/pathentityid/) { get; set; } | Gets or sets the id of path |
| [PathEntityTransformComutedFlag](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/pathentitytransformcomutedflag/) { get; set; } | Gets or sets a value indicating whether path entity transform commuted flag. |
| [PathTransformMatrix](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/pathtransformmatrix/) { get; set; } | Gets or sets the path transform matrix. |
| [PathTransformMatrix2](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/pathtransformmatrix2/) { get; set; } | Gets or sets the path transform matrix 2. |
...
| [ProprietaryBinaryData](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/proprietarybinarydata/) { get; set; } | Gets or sets the path binary data. |
| [ProprietaryBinaryDataSize](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/proprietarybinarydatasize/) { get; set; } | Gets or sets the path binary data size. |
...
| [ScaleFactor](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/scalefactor/) { get; set; } | Gets or sets the scale factor. |
...
| [SweepEntityTransformCommutedFlag](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/sweepentitytransformcommutedflag/) { get; set; } | Gets or sets a value indicating whether sweep entity transform commuted flag. |
| [SweepTransformMatrix](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/sweeptransformmatrix/) { get; set; } | Gets or sets the sweep transform matrix. |
| [SweepTransformMatrix2](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/sweeptransformmatrix2/) { get; set; } | Gets or sets the sweep transform matrix 2. |
| [SweptEntityId](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/sweptentityid/) { get; set; } | Gets or sets the id of swept |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency/) { get; set; } | Gets or sets the transparency. |
| [TwistAngle](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/twistangle/) { get; set; } | Gets or sets the twist angle. |
| [TwistControlVector](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/twistcontrolvector/) { get; set; } | Gets or sets the twist control vector. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadsweptsurface/typename/) { get; } | Gets the name of the type. |
