...
```csharp
public class CadAcshTorusClass : CadDbEvalExpr
```
...
| Name | Description |
| --- | --- |
| [CadAcshTorusClass](cadacshtorusclass/)() | Initializes a new instance of the `CadAcshTorusClass` class. |
...
| [HistoryNode](../../aspose.cad.fileformats.cad.cadobjects/cadacshtorusclass/historynode/) { get; set; } | The HistoryNode |
...
| [Major](../../aspose.cad.fileformats.cad.cadobjects/cadacshtorusclass/major/) { get; set; } | The major |
| [MajorRadius](../../aspose.cad.fileformats.cad.cadobjects/cadacshtorusclass/majorradius/) { get; set; } | The major radius |
| [Minor](../../aspose.cad.fileformats.cad.cadobjects/cadacshtorusclass/minor/) { get; set; } | The minor |
| [MinorRadius](../../aspose.cad.fileformats.cad.cadobjects/cadacshtorusclass/minorradius/) { get; set; } | The minor radius |
