...
| Name | Description |
| --- | --- |
| [CadTableFormat](cadtableformat/)() | Initializes a new instance of the [`CadCellStyleMap`](../cadcellstylemap/) class. |
...
| [CellMargin](../../aspose.cad.fileformats.cad.cadobjects/cadtableformat/cellmargin/) { get; set; } | Gets or sets the cell margin. |
| [ChildObjects](../../aspose.cad.fileformats.cad.cadobjects/cadbaseobject/childobjects/) { get; set; } | Gets or sets the child objects. |
| [ContentFormat](../../aspose.cad.fileformats.cad.cadobjects/cadtableformat/contentformat/) { get; set; } | Gets or sets the content format. |
...
| [GridFormats](../../aspose.cad.fileformats.cad.cadobjects/cadtableformat/gridformats/) { get; set; } | Gets or sets the grid formats. |
