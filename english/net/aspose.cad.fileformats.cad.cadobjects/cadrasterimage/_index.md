...
```csharp
public class CadRasterImage : CadExtrudedEntityBase
```
...
| Name | Description |
| --- | --- |
| [CadRasterImage](cadrasterimage/#constructor)() | Initializes a new instance of the `CadRasterImage` class. |
| [CadRasterImage](cadrasterimage/#constructor_1)(CadRasterImageDef, Cad3DPoint, Cad3DPoint, Cad3DPoint) | Initializes a new instance of the `CadRasterImage` class. |
...
| [ClippingBoundaryType](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/clippingboundarytype/) { get; set; } | Gets or sets the type of the clipping boundary. |
| [ClippingState](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/clippingstate/) { get; set; } | Gets or sets clipping state value. |
...
| [DisplayFlags](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/displayflags/) { get; set; } | Gets or sets display flags value. |
...
| virtual [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects/cadextrudedentitybase/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
...
| [ImageBrightness](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/imagebrightness/) { get; set; } | Gets or sets brigthness value. |
| [ImageContrast](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/imagecontrast/) { get; set; } | Gets or sets contrast value. |
| [ImageDefReactorReference](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/imagedefreactorreference/) { get; set; } | Gets or sets the image definition reactor reference. |
| [ImageDefReference](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/imagedefreference/) { get; set; } | Gets or sets ImageDefReference value. |
| [ImageFade](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/imagefade/) { get; set; } | Gets or sets fade value. |
| [ImageSizeU](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/imagesizeu/) { get; set; } | Gets or sets image size U value. |
| [ImageSizeV](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/imagesizev/) { get; set; } | Gets or sets image size V value. |
| [InsertionPoint](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/insertionpoint/) { get; set; } | Gets or sets insertion point value. |
...
| [NumberOfClipBoundaryVertices](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/numberofclipboundaryvertices/) { get; set; } | Gets or sets the number of clip boundary vertices. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/typename/) { get; } | Gets the name of the type. |
| [UVector](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/uvector/) { get; set; } | Gets or sets U vector. |
...
| [VVector](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimage/vvector/) { get; set; } | Gets or sets V vector. |
