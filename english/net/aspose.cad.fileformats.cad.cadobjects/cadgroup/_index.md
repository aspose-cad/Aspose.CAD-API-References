---
title: Class CadGroup
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.CadGroup class. Class describing CadGroup object
type: docs
weight: 2640
...
| Name | Description |
| --- | --- |
| [CadGroup](cadgroup/)() | Initializes a new instance of the `CadGroup` class. |
...
| [Description](../../aspose.cad.fileformats.cad.cadobjects/cadgroup/description/) { get; set; } | Gets or sets the description. |
...
| [HardPointerHandles](../../aspose.cad.fileformats.cad.cadobjects/cadgroup/hardpointerhandles/) { get; set; } | Gets or sets the hard pointer handles. |
...
| [SelectabilityFlag](../../aspose.cad.fileformats.cad.cadobjects/cadgroup/selectabilityflag/) { get; set; } | Gets or sets the selectability flag. |
...
| [UnnamedFlag](../../aspose.cad.fileformats.cad.cadobjects/cadgroup/unnamedflag/) { get; set; } | Gets or sets the unnamed flag. |
