---
title: Class CadArcLengthDimension
...
```csharp
public class CadArcLengthDimension : CadDimensionBase
```
...
| Name | Description |
| --- | --- |
| [CadArcLengthDimension](cadarclengthdimension/)() | Initializes a new instance of the `CadArcLengthDimension` class. |
...
| [DimLineArcPoint](../../aspose.cad.fileformats.cad.cadobjects/cadarclengthdimension/dimlinearcpoint/) { get; set; } | Gets or sets the dim line arc point. |
...
| [EndAngle](../../aspose.cad.fileformats.cad.cadobjects/cadarclengthdimension/endangle/) { get; set; } | Gets or sets the end angle. |
| [ExtensionLine1Point](../../aspose.cad.fileformats.cad.cadobjects/cadarclengthdimension/extensionline1point/) { get; set; } | Gets or sets the extension line 1 point. |
| [ExtensionLine2Point](../../aspose.cad.fileformats.cad.cadobjects/cadarclengthdimension/extensionline2point/) { get; set; } | Gets or sets the extension line 2 point. |
...
| [HasLeader](../../aspose.cad.fileformats.cad.cadobjects/cadarclengthdimension/hasleader/) { get; set; } | Gets or sets the has leader. |
...
| [IsPartial](../../aspose.cad.fileformats.cad.cadobjects/cadarclengthdimension/ispartial/) { get; set; } | Gets or sets the is partial |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadarclengthdimension/typename/) { get; } | Gets the name of the type. |
