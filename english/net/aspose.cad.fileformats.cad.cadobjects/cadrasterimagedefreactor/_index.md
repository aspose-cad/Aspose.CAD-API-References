---
title: Class CadRasterImageDefReactor
...
| Name | Description |
| --- | --- |
| [CadRasterImageDefReactor](cadrasterimagedefreactor/)() | Initializes a new instance of the `CadRasterImageDefReactor` class. |
...
| [AssociatedObjectID](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedefreactor/associatedobjectid/) { get; set; } | Gets or sets the associated object identifier. |
...
| [ClassVersion2](../../aspose.cad.fileformats.cad.cadobjects/cadrasterimagedefreactor/classversion2/) { get; set; } | Gets or sets the class version2. |
