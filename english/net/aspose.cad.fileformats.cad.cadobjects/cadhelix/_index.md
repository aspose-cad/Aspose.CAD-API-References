...
```csharp
public class CadHelix : CadEntityBase
```
...
| Name | Description |
| --- | --- |
| [CadHelix](cadhelix/)() | Initializes a new instance of the `CadHelix` class. |
...
| [AxisBasePoint](../../aspose.cad.fileformats.cad.cadobjects/cadhelix/axisbasepoint/) { get; set; } | Gets or sets the axis base point. |
| [AxisPoints](../../aspose.cad.fileformats.cad.cadobjects/cadhelix/axispoints/) { get; set; } | Gets or sets the axis points. |
...
| [ConstrainType](../../aspose.cad.fileformats.cad.cadobjects/cadhelix/constraintype/) { get; set; } | Gets or sets the type of the constrain. |
...
| [Handedness](../../aspose.cad.fileformats.cad.cadobjects/cadhelix/handedness/) { get; set; } | Gets or sets a value indicating whether this `CadHelix` is left or right handed. |
...
| [MaintainanceReleaseNumber](../../aspose.cad.fileformats.cad.cadobjects/cadhelix/maintainancereleasenumber/) { get; set; } | Gets or sets the maintainance release number. |
| [MajorReleaseNumber](../../aspose.cad.fileformats.cad.cadobjects/cadhelix/majorreleasenumber/) { get; set; } | Gets or sets the major release number. |
...
| [Radius](../../aspose.cad.fileformats.cad.cadobjects/cadhelix/radius/) { get; set; } | Gets or sets the radius. |
...
| [SplineObject](../../aspose.cad.fileformats.cad.cadobjects/cadhelix/splineobject/) { get; set; } | Gets or sets the spline object. |
| [StartPoint](../../aspose.cad.fileformats.cad.cadobjects/cadhelix/startpoint/) { get; set; } | Gets or sets the start point. |
...
| [TurnLength](../../aspose.cad.fileformats.cad.cadobjects/cadhelix/turnlength/) { get; set; } | Gets or sets the turn length. |
| [TurnsNumber](../../aspose.cad.fileformats.cad.cadobjects/cadhelix/turnsnumber/) { get; set; } | Gets or sets the turns number. |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects/cadhelix/typename/) { get; } | Gets the name of the type. |
