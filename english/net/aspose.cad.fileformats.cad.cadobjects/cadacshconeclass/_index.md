...
```csharp
public class CadAcshConeClass : CadDbEvalExpr
```
...
| Name | Description |
| --- | --- |
| [CadAcshConeClass](cadacshconeclass/)() | Initializes a new instance of the [`CadAcshBoxClass`](../cadacshboxclass/) class. |
...
| [Height](../../aspose.cad.fileformats.cad.cadobjects/cadacshconeclass/height/) { get; set; } | The height |
| [HistoryNode](../../aspose.cad.fileformats.cad.cadobjects/cadacshconeclass/historynode/) { get; set; } | The HistoryNode |
...
| [Major](../../aspose.cad.fileformats.cad.cadobjects/cadacshconeclass/major/) { get; set; } | The major |
| [MajorRadius](../../aspose.cad.fileformats.cad.cadobjects/cadacshconeclass/majorradius/) { get; set; } | The major radius |
| [Minor](../../aspose.cad.fileformats.cad.cadobjects/cadacshconeclass/minor/) { get; set; } | The minor |
| [MinorRadius](../../aspose.cad.fileformats.cad.cadobjects/cadacshconeclass/minorradius/) { get; set; } | The minor radius |
...
| [Radius](../../aspose.cad.fileformats.cad.cadobjects/cadacshconeclass/radius/) { get; set; } | The radius |
