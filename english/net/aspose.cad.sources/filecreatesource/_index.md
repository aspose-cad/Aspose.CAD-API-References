...
| Name | Description |
| --- | --- |
| [FilePath](../../aspose.cad.sources/filecreatesource/filepath/) { get; } | Gets the file path to create. |
| override [IsTemporal](../../aspose.cad.sources/filecreatesource/istemporal/) { get; } | Gets a value indicating whether file will be temporal. |

## Methods

| Name | Description |
| --- | --- |
| override [GetStreamContainer](../../aspose.cad.sources/filecreatesource/getstreamcontainer/)() | Gets the stream container. |
