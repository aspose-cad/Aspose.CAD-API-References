...
---
## Vector4Array(ArraySegment&lt;byte&gt;, int, EncodingType, bool) {#constructor}

Initializes a new instance of the [`Vector4Array`](../) struct.

```csharp
public Vector4Array(ArraySegment<byte> source, int byteStride = 0, 
...
## Vector4Array(ArraySegment&lt;byte&gt;, int, int, int, EncodingType, bool) {#constructor_1}

Initializes a new instance of the [`Vector4Array`](../) struct.

```csharp
public Vector4Array(ArraySegment<byte> source, int byteOffset, int itemsCount, int byteStride, 
    EncodingType encoding = EncodingType.FLOAT, bool normalized = false)
```
