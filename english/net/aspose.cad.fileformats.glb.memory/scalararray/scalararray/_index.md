...
---
## ScalarArray(ArraySegment&lt;byte&gt;, int, EncodingType, bool) {#constructor}

Initializes a new instance of the [`ScalarArray`](../) struct.

```csharp
public ScalarArray(ArraySegment<byte> source, int byteStride = 0, 
...
## ScalarArray(ArraySegment&lt;byte&gt;, int, int, int, EncodingType, bool) {#constructor_1}

Initializes a new instance of the [`ScalarArray`](../) struct.

```csharp
public ScalarArray(ArraySegment<byte> source, int byteOffset, int itemsCount, int byteStride, 
    EncodingType encoding = EncodingType.FLOAT, bool normalized = false)
```
