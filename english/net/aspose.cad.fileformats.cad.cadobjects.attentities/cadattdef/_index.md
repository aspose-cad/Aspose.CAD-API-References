---
title: Class CadAttDef
second_title: Aspose.CAD for .NET API Reference
description: Aspose.CAD.FileFormats.Cad.CadObjects.AttEntities.CadAttDef class. Class describing Cad AttributeDefinitions
type: docs
weight: 1770
...
| Name | Description |
| --- | --- |
| [CadAttDef](cadattdef/)() | Initializes a new instance of the `CadAttDef` class. |
...
| [DefaultString](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/defaultstring/) { get; set; } | Gets or sets the default string. |
...
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/extrusiondirection/) { get; set; } | Gets or sets the extrusion direction. |
| [FieldLength](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/fieldlength/) { get; set; } | Gets or sets the field length. |
| [FirstAlignment](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/firstalignment/) { get; set; } | Gets or sets the first alignment. |
| [Flags](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/flags/) { get; set; } | Gets or sets the flags. |
| [GenerationFlag](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/generationflag/) { get; set; } | Gets or sets the generation flag. |
...
| [HorizontalAlignment](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/horizontalalignment/) { get; set; } | Gets or sets the horizontal alignment. |
...
| override [Id](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/id/) { get; set; } | Gets or sets the id. |
...
| [LockPositionFlag](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/lockpositionflag/) { get; set; } | Gets or sets the lock position flag. |
...
| [MultiText](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/multitext/) { get; set; } | Gets or sets the multi text. |
...
| [ObliqueAngle](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/obliqueangle/) { get; set; } | Gets or sets the oblique angle. |
...
| [PromptString](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/promptstring/) { get; set; } | Gets or sets the prompt string. |
...
| [RotationAngle](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/rotationangle/) { get; set; } | Gets or sets the rotation angle. |
| [ScaleX](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/scalex/) { get; set; } | Gets or sets the scale x. |
| [SecondAlignment](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/secondalignment/) { get; set; } | Gets or sets the second alignment. |
...
| [StyleName](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/stylename/) { get; set; } | Gets or sets the style name. |
| [TextHeight](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/textheight/) { get; set; } | Gets or sets the text height. |
| [Thickness](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/thickness/) { get; set; } | Gets or sets the thickness. |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/typename/) { get; } | Gets the name of the type. |
| [VersionNumber](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/versionnumber/) { get; set; } | Gets or sets the version number. |
| [VerticalJustification](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/verticaljustification/) { get; set; } | Gets or sets the vertical justification. |
...
| Name | Description |
| --- | --- |
| [Clone](../../aspose.cad.fileformats.cad.cadobjects.attentities/cadattdef/clone/)() | Clones current object |
