...
description: "The TRIFANS."
type: docs
weight: 10
url: /java/com.aspose.cad.fileformats.collada.fileparser.elements/trifans/
---
...
| [getPrimitives()](#getPrimitives) | Gets or sets the primitives. The TRIFANS element may have any number of primitives elements. |
| [setPrimitives(Primitives[] value)](#setPrimitives-com.aspose.cad.fileformats.collada.fileparser.elements.Primitives:A) | Gets or sets the primitives. The TRIFANS element may have any number of primitives elements. |
...
| [getCount()](#getCount) | Gets or sets the count. The count attribute indicates the number of triangle fan primitives. Required attribute. |
| [setCount(long value)](#setCount-long) | Gets or sets the count. The count attribute indicates the number of triangle fan primitives. Required attribute. |
