...
type: docs
weight: 1990
url: /ru/net/aspose.cad.fileformats.cad.cadobjects/cadacdbdynamicblockpurgepreventerversion/
---
...
| Имя | Описание |
| --- | --- |
| [CadAcDbDynamicBlockPurgePreventerVersion](cadacdbdynamicblockpurgepreventerversion)() | Конструктор по умолчанию. |
