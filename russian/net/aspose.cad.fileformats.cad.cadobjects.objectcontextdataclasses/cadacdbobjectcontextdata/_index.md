...
type: docs
weight: 3470
url: /ru/net/aspose.cad.fileformats.cad.cadobjects.objectcontextdataclasses/cadacdbobjectcontextdata/
---
...
| Имя | Описание |
| --- | --- |
| [CadAcDbObjectContextData](cadacdbobjectcontextdata)() | Конструктор по умолчанию. |
