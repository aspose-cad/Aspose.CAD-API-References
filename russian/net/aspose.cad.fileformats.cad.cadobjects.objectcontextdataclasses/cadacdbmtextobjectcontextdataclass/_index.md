...
type: docs
weight: 3460
url: /ru/net/aspose.cad.fileformats.cad.cadobjects.objectcontextdataclasses/cadacdbmtextobjectcontextdataclass/
---
...
| Имя | Описание |
| --- | --- |
| [CadAcDbMTextObjectContextDataClass](cadacdbmtextobjectcontextdataclass)() | Конструктор по умолчанию. |
