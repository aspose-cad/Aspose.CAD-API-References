...
type: docs
weight: 3450
url: /ru/net/aspose.cad.fileformats.cad.cadobjects.objectcontextdataclasses/cadacdbmleaderobjectcontextdataclass/
---
...
| Имя | Описание |
| --- | --- |
| [CadAcDbMLeaderObjectContextDataClass](cadacdbmleaderobjectcontextdataclass)() | Конструктор по умолчанию. |

## Характеристики

| Имя | Описание |
| --- | --- |
| [AnnotateScaleParameterList](../../aspose.cad.fileformats.cad.cadobjects.objectcontextdataclasses/cadacdbmleaderobjectcontextdataclass/annotatescaleparameterlist) { get; set; } |  |
...
* пространство имен [Aspose.CAD.FileFormats.Cad.CadObjects.ObjectContextDataClasses](../../aspose.cad.fileformats.cad.cadobjects.objectcontextdataclasses)
* сборка [Aspose.CAD](../../)
