...
type: docs
weight: 3440
url: /ru/net/aspose.cad.fileformats.cad.cadobjects.objectcontextdataclasses/cadacdbaldimobjectcontextdataclass/
---
...
| Имя | Описание |
| --- | --- |
| [CadAcDbAlDimObjectContextDataClass](cadacdbaldimobjectcontextdataclass)() | Конструктор по умолчанию. |
