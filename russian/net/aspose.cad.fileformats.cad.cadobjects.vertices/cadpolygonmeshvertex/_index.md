...
type: docs
weight: 3700
url: /ru/net/aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/
---
...
| Имя | Описание |
| --- | --- |
| [CadPolygonMeshVertex](cadpolygonmeshvertex)() | Конструктор по умолчанию. |
...
| override [Bugle](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/bugle) { get; set; } |  |
...
| override [CurveFitTangentDirection](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/curvefittangentdirection) { get; set; } |  |
| [EmbeddedObjectsContainer](../../aspose.cad.fileformats.cad.cadobjects/cadbase/embeddedobjectscontainer) { get; set; } |  |
| override [EndingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/endingwidth) { get; set; } |  |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode) { get; set; } |  |
| override [Flags](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/flags) { get; set; } |  |
...
| override [LocationPoint](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/locationpoint) { get; set; } |  |
...
| override [MeshVertexIndex1](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/meshvertexindex1) { get; set; } |  |
| override [MeshVertexIndex2](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/meshvertexindex2) { get; set; } |  |
| override [MeshVertexIndex3](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/meshvertexindex3) { get; set; } |  |
| override [MeshVertexIndex4](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/meshvertexindex4) { get; set; } |  |
...
| override [StartingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/startingwidth) { get; set; } |  |
...
| override [VertexId](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadpolygonmeshvertex/vertexid) { get; set; } |  |
