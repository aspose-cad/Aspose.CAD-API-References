...
type: docs
weight: 3720
url: /ru/net/aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/
---
...
| Имя | Описание |
| --- | --- |
| [CadVertexPolyFaceMesh](cadvertexpolyfacemesh)() | Конструктор по умолчанию. |
...
| override [Bugle](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/bugle) { get; set; } |  |
...
| override [CurveFitTangentDirection](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/curvefittangentdirection) { get; set; } |  |
| [EmbeddedObjectsContainer](../../aspose.cad.fileformats.cad.cadobjects/cadbase/embeddedobjectscontainer) { get; set; } |  |
| override [EndingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/endingwidth) { get; set; } |  |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode) { get; set; } |  |
| override [Flags](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/flags) { get; set; } |  |
...
| override [LocationPoint](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/locationpoint) { get; set; } |  |
...
| override [MeshVertexIndex1](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/meshvertexindex1) { get; set; } |  |
| override [MeshVertexIndex2](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/meshvertexindex2) { get; set; } |  |
| override [MeshVertexIndex3](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/meshvertexindex3) { get; set; } |  |
| override [MeshVertexIndex4](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/meshvertexindex4) { get; set; } |  |
...
| override [StartingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/startingwidth) { get; set; } |  |
...
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexbase/typename) { get; } |  |
| override [VertexId](../../aspose.cad.fileformats.cad.cadobjects.vertices/cadvertexpolyfacemesh/vertexid) { get; set; } |  |
...
* пространство имен [Aspose.CAD.FileFormats.Cad.CadObjects.Vertices](../../aspose.cad.fileformats.cad.cadobjects.vertices)
* сборка [Aspose.CAD](../../)
