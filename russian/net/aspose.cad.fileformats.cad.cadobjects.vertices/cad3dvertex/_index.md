...
type: docs
weight: 3680
url: /ru/net/aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/
---
## Cad3DVertex class
...
| Имя | Описание |
| --- | --- |
| [Cad3DVertex](cad3dvertex)() | Конструктор по умолчанию. |
...
| override [Bugle](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/bugle) { get; set; } |  |
...
| override [CurveFitTangentDirection](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/curvefittangentdirection) { get; set; } |  |
| [EmbeddedObjectsContainer](../../aspose.cad.fileformats.cad.cadobjects/cadbase/embeddedobjectscontainer) { get; set; } |  |
| override [EndingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/endingwidth) { get; set; } |  |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode) { get; set; } |  |
| override [Flags](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/flags) { get; set; } |  |
...
| override [LocationPoint](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/locationpoint) { get; set; } |  |
...
| override [MeshVertexIndex1](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/meshvertexindex1) { get; set; } |  |
| override [MeshVertexIndex2](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/meshvertexindex2) { get; set; } |  |
| override [MeshVertexIndex3](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/meshvertexindex3) { get; set; } |  |
| override [MeshVertexIndex4](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/meshvertexindex4) { get; set; } |  |
...
| override [StartingWidth](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/startingwidth) { get; set; } |  |
...
| override [VertexId](../../aspose.cad.fileformats.cad.cadobjects.vertices/cad3dvertex/vertexid) { get; set; } |  |
