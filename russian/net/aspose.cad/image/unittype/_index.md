...
description: Получает тип текущего юнита.
type: docs
weight: 80
url: /ru/net/aspose.cad/image/unittype/
---
## Image.UnitType property

Получает тип текущего юнита.
...
Нормализация размера страницы экспорта, несмотря на тип единицы измерения, определенный на чертеже
