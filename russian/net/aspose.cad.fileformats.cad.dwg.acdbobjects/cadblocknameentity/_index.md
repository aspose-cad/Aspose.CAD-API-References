...
description: Объект BlockName
type: docs
weight: 3990
url: /ru/net/aspose.cad.fileformats.cad.dwg.acdbobjects/cadblocknameentity/
---
...
| Имя | Описание |
| --- | --- |
| [CadBlockNameEntity](cadblocknameentity)() | Конструктор по умолчанию. |
...
| [BlockName](../../aspose.cad.fileformats.cad.dwg.acdbobjects/cadblocknameentity/blockname) { get; set; } | Получает или задает имя блока. |
