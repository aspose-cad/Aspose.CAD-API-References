...
description: Параметры создания файла формата wmf.
type: docs
weight: 29990
url: /ru/net/aspose.cad.imageoptions/wmfoptions/
---
## WmfOptions class

Параметры создания файла формата wmf.
...
| Имя | Описание |
| --- | --- |
| [WmfOptions](wmfoptions#constructor)() | Инициализирует новый экземпляр класса[`WmfOptions`](../wmfoptions). |
| [WmfOptions](wmfoptions#constructor_1)(WmfOptions) | Инициализирует новый экземпляр класса[`WmfOptions`](../wmfoptions). |

## Характеристики

| Имя | Описание |
| --- | --- |
| [BitsPerPixel](../../aspose.cad.imageoptions/wmfoptions/bitsperpixel) { get; set; } | Получает или задает количество бит изображения на пиксель. |
