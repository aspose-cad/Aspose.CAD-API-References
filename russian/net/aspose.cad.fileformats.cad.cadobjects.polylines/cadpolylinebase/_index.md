...
type: docs
weight: 3540
url: /ru/net/aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/
---
...
| Имя | Описание |
| --- | --- |
| [CadPolylineBase](cadpolylinebase)() | Конструктор по умолчанию. |
...
| virtual [Elevation](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/elevation) { get; set; } |  |
| [EmbeddedObjectsContainer](../../aspose.cad.fileformats.cad.cadobjects/cadbase/embeddedobjectscontainer) { get; set; } |  |
| virtual [EndWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/endwidth) { get; set; } |  |
...
| [Flag](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/flag) { get; set; } |  |
...
| virtual [MeshMVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/meshmvertexcount) { get; set; } |  |
| virtual [MeshNVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/meshnvertexcount) { get; set; } |  |
...
| virtual [StartWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/startwidth) { get; set; } |  |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag) { get; set; } |  |
| virtual [SurfaceMDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/surfacemdensity) { get; set; } |  |
| virtual [SurfaceNDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/surfacendensity) { get; set; } |  |
| virtual [SurfaceType](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/surfacetype) { get; set; } |  |
| virtual [Thickness](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/thickness) { get; set; } |  |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency) { get; set; } |  |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolylinebase/typename) { get; } |  |
...
* пространство имен [Aspose.CAD.FileFormats.Cad.CadObjects.Polylines](../../aspose.cad.fileformats.cad.cadobjects.polylines)
* сборка [Aspose.CAD](../../)
