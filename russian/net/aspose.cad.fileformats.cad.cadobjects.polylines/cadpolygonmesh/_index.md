...
type: docs
weight: 3510
url: /ru/net/aspose.cad.fileformats.cad.cadobjects.polylines/cadpolygonmesh/
---
...
| Имя | Описание |
| --- | --- |
| [CadPolygonMesh](cadpolygonmesh)() | Конструктор по умолчанию. |
...
| override [Elevation](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolygonmesh/elevation) { get; set; } |  |
| [EmbeddedObjectsContainer](../../aspose.cad.fileformats.cad.cadobjects/cadbase/embeddedobjectscontainer) { get; set; } |  |
| override [EndWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolygonmesh/endwidth) { get; set; } |  |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode) { get; set; } |  |
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolygonmesh/extrusiondirection) { get; set; } |  |
...
| override [MeshMVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolygonmesh/meshmvertexcount) { get; set; } |  |
| override [MeshNVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolygonmesh/meshnvertexcount) { get; set; } |  |
...
| override [StartWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolygonmesh/startwidth) { get; set; } |  |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag) { get; set; } |  |
| override [SurfaceMDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolygonmesh/surfacemdensity) { get; set; } |  |
| override [SurfaceNDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolygonmesh/surfacendensity) { get; set; } |  |
| override [SurfaceType](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolygonmesh/surfacetype) { get; set; } |  |
| override [Thickness](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolygonmesh/thickness) { get; set; } |  |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency) { get; set; } |  |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolygonmesh/typename) { get; } |  |
