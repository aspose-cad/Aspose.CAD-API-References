...
type: docs
weight: 3520
url: /ru/net/aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/
---
## CadPolyline class
...
| Имя | Описание |
| --- | --- |
| [CadPolyline](cadpolyline)() | Конструктор по умолчанию. |
...
| override [Elevation](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/elevation) { get; set; } |  |
| [EmbeddedObjectsContainer](../../aspose.cad.fileformats.cad.cadobjects/cadbase/embeddedobjectscontainer) { get; set; } |  |
| override [EndWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/endwidth) { get; set; } |  |
| [Entmode](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/entmode) { get; set; } |  |
| override [ExtrusionDirection](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/extrusiondirection) { get; set; } |  |
...
| override [MeshMVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/meshmvertexcount) { get; set; } |  |
| override [MeshNVertexCount](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/meshnvertexcount) { get; set; } |  |
...
| override [StartWidth](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/startwidth) { get; set; } |  |
| [StorageFlag](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/storageflag) { get; set; } |  |
| override [SurfaceMDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/surfacemdensity) { get; set; } |  |
| override [SurfaceNDensity](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/surfacendensity) { get; set; } |  |
| override [SurfaceType](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/surfacetype) { get; set; } |  |
| override [Thickness](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/thickness) { get; set; } |  |
| [Transparency](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/transparency) { get; set; } |  |
| override [TypeName](../../aspose.cad.fileformats.cad.cadobjects.polylines/cadpolyline/typename) { get; } |  |
