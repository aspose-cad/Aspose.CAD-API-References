...
type: docs
weight: 3740
url: /ru/net/aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/
---
...
| Имя | Описание |
| --- | --- |
| [CadWipeoutBase](cadwipeoutbase)() | Конструктор по умолчанию. |
...
| virtual [ClassVersion](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/classversion) { get; set; } |  |
| [ClipBoundaries](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/clipboundaries) { get; set; } |  |
| virtual [ClipBoundariesCount](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/clipboundariescount) { get; set; } |  |
| virtual [ClippingBoundaryType](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/clippingboundarytype) { get; set; } |  |
| virtual [ClippingState](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/clippingstate) { get; set; } |  |
...
| virtual [Fade](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/fade) { get; set; } |  |
...
| virtual [ImageDefReactorReference](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/imagedefreactorreference) { get; set; } |  |
| virtual [ImageDefReference](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/imagedefreference) { get; set; } |  |
| virtual [ImageDisplayProp](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/imagedisplayprop) { get; set; } |  |
| virtual [ImageSizeInPixels](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/imagesizeinpixels) { get; set; } |  |
| virtual [InsertionPoint](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/insertionpoint) { get; set; } |  |
...
| virtual [VectorU](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/vectoru) { get; set; } |  |
| virtual [VectorV](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/vectorv) { get; set; } |  |
| virtual [Visible](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/visible) { get; set; } |  |
| virtual [WipeoutBrightness](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/wipeoutbrightness) { get; set; } |  |
| virtual [WipeoutContrast](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/wipeoutcontrast) { get; set; } |  |
...
* пространство имен [Aspose.CAD.FileFormats.Cad.CadObjects.Wipeout](../../aspose.cad.fileformats.cad.cadobjects.wipeout)
* сборка [Aspose.CAD](../../)
