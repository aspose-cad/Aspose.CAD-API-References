...
type: docs
weight: 3730
url: /ru/net/aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/
---
## CadWipeout class
...
| Имя | Описание |
| --- | --- |
| [CadWipeout](cadwipeout)() | Конструктор по умолчанию. |
...
| override [ClassVersion](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/classversion) { get; set; } |  |
| [ClipBoundaries](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeoutbase/clipboundaries) { get; set; } |  |
| override [ClipBoundariesCount](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/clipboundariescount) { get; set; } |  |
| override [ClippingBoundaryType](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/clippingboundarytype) { get; set; } |  |
| override [ClippingState](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/clippingstate) { get; set; } |  |
...
| override [Fade](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/fade) { get; set; } |  |
...
| override [ImageDefReactorReference](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/imagedefreactorreference) { get; set; } |  |
| override [ImageDefReference](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/imagedefreference) { get; set; } |  |
| override [ImageDisplayProp](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/imagedisplayprop) { get; set; } |  |
| override [ImageSizeInPixels](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/imagesizeinpixels) { get; set; } |  |
| override [InsertionPoint](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/insertionpoint) { get; set; } |  |
...
| override [VectorU](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/vectoru) { get; set; } |  |
| override [VectorV](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/vectorv) { get; set; } |  |
| virtual [Visible](../../aspose.cad.fileformats.cad.cadobjects/cadbaseentity/visible) { get; set; } |  |
| override [WipeoutBrightness](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/wipeoutbrightness) { get; set; } |  |
| override [WipeoutContrast](../../aspose.cad.fileformats.cad.cadobjects.wipeout/cadwipeout/wipeoutcontrast) { get; set; } |  |
