...
type: docs
weight: 21550
url: /ru/net/aspose.cad.fileformats.ifc.ifc4.entities/ifcreinforcingbar/
---
...
| Имя | Описание |
| --- | --- |
| [IfcReinforcingBar](ifcreinforcingbar)() | Конструктор по умолчанию. |

## Характеристики

| Имя | Описание |
| --- | --- |
| [BarLength](../../aspose.cad.fileformats.ifc.ifc4.entities/ifcreinforcingbar/barlength) { get; set; } | Длина стержня |
| [BarSurface](../../aspose.cad.fileformats.ifc.ifc4.entities/ifcreinforcingbar/barsurface) { get; set; } | BarSurface |
...
| [CrossSectionArea](../../aspose.cad.fileformats.ifc.ifc4.entities/ifcreinforcingbar/crosssectionarea) { get; set; } | CrossSectionArea |
...
| [NominalDiameter](../../aspose.cad.fileformats.ifc.ifc4.entities/ifcreinforcingbar/nominaldiameter) { get; set; } | Номинальный диаметр |
...
| [PredefinedType](../../aspose.cad.fileformats.ifc.ifc4.entities/ifcreinforcingbar/predefinedtype) { get; set; } | PredefinedType |
