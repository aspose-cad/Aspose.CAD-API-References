...
description: IfcTendon
type: docs
weight: 23490
url: /ru/net/aspose.cad.fileformats.ifc.ifc4.entities/ifctendon/
---
## IfcTendon class
...
| Имя | Описание |
| --- | --- |
| [IfcTendon](ifctendon)() | Конструктор по умолчанию. |

## Характеристики

| Имя | Описание |
| --- | --- |
| [AnchorageSlip](../../aspose.cad.fileformats.ifc.ifc4.entities/ifctendon/anchorageslip) { get; set; } | AnchorageSlip |
...
| [CrossSectionArea](../../aspose.cad.fileformats.ifc.ifc4.entities/ifctendon/crosssectionarea) { get; set; } | CrossSectionArea |
...
| [FrictionCoefficient](../../aspose.cad.fileformats.ifc.ifc4.entities/ifctendon/frictioncoefficient) { get; set; } | Коэффициент трения |
...
| [MinCurvatureRadius](../../aspose.cad.fileformats.ifc.ifc4.entities/ifctendon/mincurvatureradius) { get; set; } | MinCurvatureRadius |
...
| [NominalDiameter](../../aspose.cad.fileformats.ifc.ifc4.entities/ifctendon/nominaldiameter) { get; set; } | Номинальный диаметр |
...
| [PredefinedType](../../aspose.cad.fileformats.ifc.ifc4.entities/ifctendon/predefinedtype) { get; set; } | PredefinedType |
| [PreStress](../../aspose.cad.fileformats.ifc.ifc4.entities/ifctendon/prestress) { get; set; } | PreStress |
...
| [Tag](../../aspose.cad.fileformats.ifc.ifc4.entities/ifcelement/tag) { get; set; } | Тег |
| [TensionForce](../../aspose.cad.fileformats.ifc.ifc4.entities/ifctendon/tensionforce) { get; set; } | TensionForce |
