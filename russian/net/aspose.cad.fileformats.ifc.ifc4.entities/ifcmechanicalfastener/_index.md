...
description: IfcMechanicalFastener
type: docs
weight: 20200
url: /ru/net/aspose.cad.fileformats.ifc.ifc4.entities/ifcmechanicalfastener/
---
...
| Имя | Описание |
| --- | --- |
| [IfcMechanicalFastener](ifcmechanicalfastener)() | Конструктор по умолчанию. |
...
| [NominalDiameter](../../aspose.cad.fileformats.ifc.ifc4.entities/ifcmechanicalfastener/nominaldiameter) { get; set; } | Номинальный диаметр |
| [NominalLength](../../aspose.cad.fileformats.ifc.ifc4.entities/ifcmechanicalfastener/nominallength) { get; set; } | Номинальная длина |
